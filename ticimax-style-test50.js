 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var mh;function Gx(){if(mh)return Ct;mh=1;var a=tf();function r(b){var x="https://react.dev/errors/"+b;if(1<arguments.length){x+="?args[]="+encodeURIComponent(arguments[1]);for(var S=2;S<arguments.length;S++)x+="&args[]="+encodeURIComponent(arguments[S])}return"Minified React error #"+b+"; visit "+x+" for the full message or use the non-minified dev environment for full errors and additional helpful warnings."}function u(){}var o={d:{f:u,r:function(){throw Error(r(522))},D:u,C:u,L:u,m:u,X:u,S:u,M:u},p:0,findDOMNode:null},c=Symbol.for("react.portal");function d(b,x,S){var E=3<arguments.length&&arguments[3]!==void 0?arguments[3]:null;return{$$typeof:c,key:E==null?null:""+E,children:b,containerInfo:x,implementation:S}}var p=a.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE;function g(b,x){if(b==="font")return"";if(typeof x=="string")return x==="use-credentials"?x:""}return Ct.__DOM_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE=o,Ct.createPortal=function(b,x){var S=2<arguments.length&&arguments[2]!==void 0?arguments[2]:null;if(!x||x.nodeType!==1&&x.nodeType!==9&&x.nodeType!==11)throw Error(r(299));return d(b,x,null,S)},Ct.flushSync=function(b){var x=p.T,S=o.p;try{if(p.T=null,o.p=2,b)return b()}finally{p.T=x,o.p=S,o.d.f()}},Ct.preconnect=function(b,x){typeof b=="string"&&(x?(x=x.crossOrigin,x=typeof x=="string"?x==="use-credentials"?x:"":void 0):x=null,o.d.C(b,x))},Ct.prefetchDNS=function(b){typeof b=="string"&&o.d.D(b)},Ct.preinit=function(b,x){if(typeof b=="string"&&x&&typeof x.as=="string"){var S=x.as,E=g(S,x.crossOrigin),A=typeof x.integrity=="string"?x.integrity:void 0,Q=typeof x.fetchPriority=="string"?x.fetchPriority:void 0;S==="style"?o.d.S(b,typeof x.precedence=="string"?x.precedence:void 0,{crossOrigin:E,integrity:A,fetchPriority:Q}):S==="script"&&o.d.X(b,{crossOrigin:E,integrity:A,fetchPriority:Q,nonce:typeof x.nonce=="string"?x.nonce:void 0})}},Ct.preinitModule=function(b,x){if(typeof b=="string")if(typeof x=="object"&&x!==null){if(x.as==null||x.as==="script"){var S=g(x.as,x.crossOrigin);o.d.M(b,{crossOrigin:S,integrity:typeof x.integrity=="string"?x.integrity:void 0,nonce:typeof x.nonce=="string"?x.nonce:void 0})}}else x==null&&o.d.M(b)},Ct.preload=function(b,x){if(typeof b=="string"&&typeof x=="object"&&x!==null&&typeof x.as=="string"){var S=x.as,E=g(S,x.crossOrigin);o.d.L(b,S,{crossOrigin:E,integrity:typeof x.integrity=="string"?x.integrity:void 0,nonce:typeof x.nonce=="string"?x.nonce:void 0,type:typeof x.type=="string"?x.type:void 0,fetchPriority:typeof x.fetchPriority=="string"?x.fetchPriority:void 0,referrerPolicy:typeof x.referrerPolicy=="string"?x.referrerPolicy:void 0,imageSrcSet:typeof x.imageSrcSet=="string"?x.imageSrcSet:void 0,imageSizes:typeof x.imageSizes=="string"?x.imageSizes:void 0,media:typeof x.media=="string"?x.media:void 0})}},Ct.preloadModule=function(b,x){if(typeof b=="string")if(x){var S=g(x.as,x.crossOrigin);o.d.m(b,{as:typeof x.as=="string"&&x.as!=="script"?x.as:void 0,crossOrigin:S,integrity:typeof x.integrity=="string"?x.integrity:void 0})}else o.d.m(b)},Ct.requestFormReset=function(b){o.d.r(b)},Ct.unstable_batchedUpdates=function(b,x){return b(x)},Ct.useFormState=function(b,x,S){return p.H.useFormState(b,x,S)},Ct.useFormStatus=function(){return p.H.useHostTransitionStatus()},Ct.version="19.1.1",Ct}var gh;function xp(){if(gh)return Dc.exports;gh=1;function a(){if(!(typeof __REACT_DEVTOOLS_GLOBAL_HOOK__>"u"||typeof __REACT_DEVTOOLS_GLOBAL_HOOK__.checkDCE!="function"))try{__REACT_DEVTOOLS_GLOBAL_HOOK__.checkDCE(a)}catch(r){console.error(r)}}return a(),Dc.exports=Gx(),Dc.exports}/**
 * @license React
...
`,z2=({mainColor:a,stockReminderUsageChannel:r,forceOpen:u})=>{const o=Y.useRef(null),[c,d]=Y.useState(u||!1),[p,g]=Y.useState(!1),[b,x]=Y.useState(""),[S,E]=Y.useState(!1),[A,Q]=Y.useState(),[M,q]=Y.useState(),[C,F]=Y.useState(!1),H=Y.useRef(null),X=Y.useRef(null),le=Y.useRef(null),B=()=>{document.querySelectorAll(".nostok").forEach(y=>{if(!y.querySelector(".stock_bell_icon")){const _=document.createElement("i");_.className="fal fa-bell stock_bell_icon",_.style.fontSize="14px",_.style.color="#000",_.style.fontWeight="500",_.style.marginLeft="5px",_.style.transition="0.3s",y.appendChild(_)}})},te=()=>{le.current&&clearInterval(le.current),le.current=setInterval(()=>{document.querySelectorAll(".stock_bell_icon").forEach(y=>{const _=y;_.style.transform="scale(1.5)",_.style.color="red",_.style.transition="0.3s",setTimeout(()=>{_.style.transform="scale(1)",_.style.color="#000",_.style.transition="0.3s"},1e3)})},3e3)},$=()=>{const ne=document.getElementById("dynamicNostokBellStyles");ne&&ne.remove();const y=document.createElement("style");y.id="dynamicNostokBellStyles",y.innerHTML=`
    ...
    `,document.head.appendChild(y)};Y.useEffect(()=>{typeof window<"u"&&(window.currentProduct?Q(window.currentProduct):window.productDetailModel?Q(window.productDetailModel):Q({productId:1,productName:"Test Ürün",stockCode:"TEST001",productShortDescription:null,productUrl:null,productIsAsorti:!0,assortmentGroupId:1,productVariantData:[{id:1,tanim:"S",tipID:1,aktif:!0,sira:1,resim:"",resimYolu:"",renkKodu:"",ekSecenekTipiTanim:"Beden",ekSecenekTipiSira:1,ekSecenekListeTipi:1,stokAdedi:0,urunID:1,urunKartID:1,stokBilgilendir:!0,ekSecenekTipVaryasyonTuru:1,urunAktif:!0},{id:2,tanim:"M",tipID:1,aktif:!0,sira:2,resim:"",resimYolu:"",renkKodu:"",ekSecenekTipiTanim:"Beden",ekSecenekTipiSira:1,ekSecenekListeTipi:1,stokAdedi:0,urunID:2,urunKartID:1,stokBilgilendir:!0,ekSecenekTipVaryasyonTuru:1,urunAktif:!0}],products:null,moneyOrderDiscount:0,currencies:[],productPrice:100,productPriceStr:"100 TL",productPriceKDVIncluded:118,productCurrency:"TL",product:{id:1,urunAdi:"Test Ürün",stokKodu:"TEST001",barkod:"",gtipKodu:"",stokAdedi:0,eksiStokAdedi:0,konsinyeStokAdedi:0,piyasaFiyati:100,satisFiyati:100,indirimliFiyati:90,piyasaFiyatiKDV:118,satisKDV:118,indirimliKDV:106.2,kdvOrani:18,kdvDahil:!0,paraBirimiId:1,kargoAgirligi:.5,kargoUcreti:0,urunKartiId:1,aktif:!0,anaUrun:!0,spotResimAdi:null,spotResimThumbYolu:"",spotResimYolu:"",spotResimBuyukYolu:"",tedarikciKodu:"",paraBirimi:"TL",paraBirimiKodu:"TRY",paraBirimiDilKodu:"tr",urunSepetFiyati:100,urunSepetFiyatiKDV:118,urunFiyatiOrjinal:100,urunFiyatiOrjinalKDV:118,urunFiyatiOrjinalKurHaric:100,urunFiyatiOrjinalKDVKurHaric:118,indirimOrani:10,ekSecenekOzellik:null,ekSecenekOzellikDetay:null,ekSecenekOzellikDetayIDs:null,urunAdediOndalikliSayiGirilebilir:!1,urunAdediMinimumDeger:1,urunAdediVarsayilanDeger:1,urunAdediKademeDeger:1,uyeAlimMin:1,uyeAlimMaks:100,bayiAlimMin:1,bayiAlimMaks:100,resimler:null,urunKampanyaAktif:!1,urunKampanyaAdet:0,urunKampanyaUrunFiyat:0,urunKampanyaSepetTutari:0,urunKampanyaKosulsuzEklenebilir:!1,urunKampanyaNormalFiyatKullan:!1,piyasaFiyatiStr:"100 TL",satisFiyatiStr:"100 TL",indirimliFiyatiStr:"90 TL",urunFiyatiOrjinalStr:"100 TL",urunSepetFiyatiStr:"100 TL",urunFiyatiOrjinalKurHaricStr:"100 TL",tahminiTeslimSuresi:3,tahminiTeslimSuresiTarihi:"",tahminiTeslimSuresiGoster:!0,tahminiTeslimSuresiAyniGun:!1,tahminiTeslimSuresiTarih:"",tahminiTeslimUlkeler:[],minimumTaksitTutari:100,minimumTaksitTutariStr:null},productPayAtTheDoorPrice:110,productPayAtTheDoorWithCardPrice:105,openCartPopup:!1,rating:4.5,photoCommentaryMoneyPoints:10,maxInstallment:6,productFileUploadActive:!1,productFileUploadIsRequire:!1,productFileUploadMaxSize:5,productCombineActive:!1,productCombineType:0,productCategoryId:1,salesUnit:"Adet",brandName:"Test Marka",mainVariantId:1,totalStockAmount:0,productCombinePurchase:!1,productCombineBulkPurchase:!1,formId:0,videoSettings:{},dynamicForm:null,memberCriticalStock:5,productActive:!0,productDesingSetting:{},is3dImageActive:!1,indirimOraniGoster:!0,fiyatGoster:!0,showVatIncludedPrice:!0,showLocalPrice:!0,productImages:[],isSuite:!1,suite:{},isIntegral:!1,image360Type:0,estimatedDeliveryTimeShowType:1,m169804:!1,photoAddComment:!1,storeGoogleMapApiKey:"",mainProductImage:!0,noImageUrunIdList:[],memberWishList:[],askSellerQuestion:!1,showProductQuestion:!1,iyilikKazansinRate:0,previewImageAlt:"",breadCrumb:[],productAssortmentList:null,customTechnicalDetails:[],isProductCreationPruduct:!1}))},[]),Y.useEffect(()=>{typeof window<"u"&&A&&(B(),$(),te())},[A]),Y.useEffect(()=>()=>{le.current&&clearInterval(le.current)},[]);const{register:se,handleSubmit:we,formState:{errors:Ue},reset:Ce,clearErrors:W}=fr(),re=()=>{d(!1),q(null),Ce(),W(),x(""),F(!1)};o!==null&&Wi(o,re);const ve=we(ne=>{g(!0),A&&(A.productVariantData&&!M||He.post("https://api.upsell.co/phonesubscription/reminder",{...r===1||r===2?{phone:"90"+ne.phone,email:""}:{email:ne.email,phone:""},productName:A.productName,productSlug:window.location.pathname,productId:`${A.productVariantData?M?.variantOptions[0].urunID:A.product.id}`,productCardId:A.product.urunKartiId.toString(),variant:(JSON.stringify(M)??"{}")||"{}",hasVariant:A.productVariantData!==null}).then(()=>{E(!0),d(!1)}).catch(()=>{x(r===1||r===2?"Bu telefon numarası zaten kayıtlı.":"Bu e-posta adresi zaten kayıtlı.")}).finally(()=>{g(!1)}))});Y.useEffect(()=>{if(u)d(!0);else if(typeof window<"u"){const ne=J=>{J.preventDefault(),J.stopPropagation(),c||d(!0)},y=()=>{c||d(!0)};H.current=ne,X.current=y;const _=document.getElementById("upsell-ss-reminder");_&&(_.removeEventListener("click",X.current),_.addEventListener("click",y));const I=document.querySelectorAll(".nostok");if(I.forEach(J=>{H.current&&J.removeEventListener("click",H.current)}),I.forEach(J=>{J.addEventListener("click",ne)}),I.length===0&&A){const J=A.productVariantData?.find(ge=>ge.stokAdedi===0),oe=A.productVariantData===null&&A.totalStockAmount===0;if(J||oe)if(_)_.style.display="flex";else{const ge=()=>{if(typeof window.$<"u"){const ce=document.querySelector(".MiddleList");if(ce&&!document.getElementById("upsell-ss-reminder")){const ze=`
      ...
      `}}),f.jsx("p",{className:"max-category-head",children:"Kategorinin En Çok Satılan Ürünleri"}),f.jsx("div",{ref:p,className:"max-BestSellingProducts owl-carousel owl-theme",children:u.map(E=>S(E))})]}),g.current)},D2=ee.div`
  position: fixed;
  top: 0;
  left: 0;
  z-index: 9999;
...
`,ov=({mainColor:a,forceOpen:r})=>{const[u,o]=Y.useState([]),[c,d]=Y.useState(!1),[p,g]=Y.useState(0),[b,x]=Y.useState(r||!1),[S,E]=Y.useState("50px"),[A,Q]=Y.useState(null),[M,q]=Y.useState(null);return Y.useEffect(()=>{if(!document.querySelector(".ProductBody")){x(!1);return}x(r||!0)},[r]),Y.useEffect(()=>{async function C(){if(typeof window<"u"){const F=window.productDetailModel;let H=null;if(F&&F.productId?H=F.productId:H="1",H){d(!0);try{const X=await He.post("https://api.upsell.co/ProductStat/"+H,{},{headers:{"Content-Type":"application/json","Content-Length":"2"}});X.data&&X.data.data&&X.data.data.length>0?o(X.data.data):o([{text:"Son 24 saatte 15 kişi bu ürünü satın aldı",icon:"shopping-cart"},{text:"Bu ürünü 8 kişi favorilerine ekledi",icon:"heart"},{text:"Son 1 saatte 3 kişi bu ürünü görüntüledi",icon:"eye"},{text:"Bu ürün 12 kez sepete eklendi",icon:"plus-circle"}])}catch{o([{text:"Son 24 saatte 15 kişi bu ürünü satın aldı",icon:"shopping-cart"},{text:"Bu ürünü 8 kişi favorilerine ekledi",icon:"heart"},{text:"Son 1 saatte 3 kişi bu ürünü görüntüledi",icon:"eye"},{text:"Bu ürün 12 kez sepete eklendi",icon:"plus-circle"}])}finally{d(!1)}}}}C()},[]),Y.useEffect(()=>{u.length>0&&A===null&&Q(u[0])},[u,A]),Y.useEffect(()=>{if(u.length>0){const C=setInterval(()=>{g(F=>(F+1)%u.length)},4e3);return()=>clearInterval(C)}},[u]),Y.useEffect(()=>{if(u.length>0){q(A),Q(u[p]);const C=setTimeout(()=>{q(null)},500);return()=>clearTimeout(C)}},[p,u]),Y.useEffect(()=>{r&&x(!0)},[r]),Y.useEffect(()=>{if(!r){const C=setTimeout(()=>{x(!0)},4e3);return()=>clearTimeout(C)}},[r]),Y.useEffect(()=>{const C=()=>{const F=window.innerWidth<=768,H=F?"80px":"50px",X=F?"155px":"125px";E(window.scrollY>1e3?X:H)};return C(),window.addEventListener("scroll",C),window.addEventListener("resize",C),()=>{window.removeEventListener("scroll",C),window.removeEventListener("resize",C)}},[]),c||u.length===0?null:f.jsx(rv,{id:"social-proof-wrapper",open:b,bottom:S,mainColor:a,children:f.jsxs(sv,{children:[M&&f.jsxs(mp,{className:"previous",mainColor:a,children:[f.jsx("i",{className:`fa fa-${M.icon}`})," ",M.text]}),A&&f.jsxs(mp,{className:"active",mainColor:a,children:[f.jsx("i",{className:`fa fa-${A.icon}`})," ",A.text]})]})})};function cv(){const[a,r]=Y.useState(),[u]=Y.useState(!1),[o,c]=Y.useState(!1);return Y.useEffect(()=>{async function d(){c(!0);try{const p=document.querySelector(".ProductBody")!==null,g=await He.get("https://api.upsell.co/Shops");if(g.data&&g.data.success&&g.data.data){const b=g.data.data;r({mainColor:b.mainColor||"#e7333c",logo:b.logo||"https://via.placeholder.com/150x50/e7333c/white?text=LOGO",enabledPhoneSubscription:b.enabledPhoneSubscription||b.enabledSubscription||!1,enabledEmailSubscription:b.enabledEmailSubscription||b.enabledSubscription||!1,enabledGiftWheel:b.enabledGiftWheel||!1,enabledProductStat:(b.enabledProductStat||!1)&&p,enabledOrderCheck:b.enabledOrderCheck||!1,enabledWeeklyProducts:b.enabledWeeklyProducts||!1,enabledStockReminder:b.enabledStockReminder||!1,enabledSizeChart:b.enabledSizeChart||!1,useOneChartForAllProducts:b.useOneChartForAllProducts||!1,stockReminderUsageChannel:b.stockReminderUsageChannel||1})}else r({mainColor:"#e7333c",logo:"https://via.placeholder.com/150x50/e7333c/white?text=LOGO",enabledPhoneSubscription:!0,enabledEmailSubscription:!0,enabledGiftWheel:!0,enabledProductStat:p,enabledOrderCheck:!0,enabledWeeklyProducts:!0,enabledStockReminder:!0,enabledSizeChart:!0,useOneChartForAllProducts:!1,stockReminderUsageChannel:1})}catch{}finally{c(!1)}}return d(),()=>{}},[]),Y.useEffect(()=>{const d=new URLSearchParams(window.location.search),p=d.get("utm_source"),g=d.get("utm_medium"),b=d.get("utm_campaign");if(!(p==="upsell"))return;const S="uvid",E=localStorage.getItem(S),A=E||crypto.randomUUID();E||localStorage.setItem(S,A),He.post("https://api.upsell.co/Tracking/CreateVisitor",{visitorId:A,path:window.location.pathname,productId:String(window.productDetailModel?.product.urunKartiId),utm:{source:p,medium:g,campaign:b}}).catch(()=>{})},[]),Y.useEffect(()=>{const d="uvid",p=localStorage.getItem(d);if(!p)return;const g=window,b=g.orderCompletedModel,x=g.checkout_order,S=b?.orderId??x?.id??x?.orderId??null;S&&He.post("https://api.upsell.co/Tracking/MatchOrder",{visitorId:p,orderId:String(S)}).then(()=>{localStorage.removeItem(d)}).catch(()=>{})},[]),o?f.jsx("div",{children:"YÃ¼kleniyor..."}):a?a.mainColor?a.logo?f.jsxs(f.Fragment,{children:[f.jsx(j2,{}),a.enabledWeeklyProducts&&f.jsx(h2,{mainColor:a.mainColor}),u&&(a.enabledPhoneSubscription||a.enabledEmailSubscription)?f.jsx(W5,{mainColor:a.mainColor,enabledPhoneSubscription:a.enabledPhoneSubscription,enabledEmailSubscription:a.enabledEmailSubscription}):null,a.enabledGiftWheel&&f.jsx(iv,{mainColor:a.mainColor}),a.enabledProductStat&&f.jsx(ov,{mainColor:a.mainColor}),a.enabledOrderCheck&&f.jsxs(f.Fragment,{children:[f.jsx(y2,{color:a.mainColor}),f.jsx(H2,{logo:a.logo})]}),a.enabledStockReminder&&f.jsx(z2,{mainColor:a.mainColor,stockReminderUsageChannel:a.stockReminderUsageChannel}),a.enabledSizeChart&&a.useOneChartForAllProducts!==void 0&&f.jsx(U2,{useOneChartForAllProducts:a.useOneChartForAllProducts})]}):f.jsx("div",{children:"MaÄŸaza logo bilgisi eksik"}):f.jsx("div",{children:"MaÄŸaza renk bilgisi eksik"}):f.jsx("div",{children:"MaÄŸaza bilgileri yÃ¼klenemedi"})}const gp=document.getElementById("upsell-style");gp&&$x.createRoot(gp).render(f.jsx(Y.StrictMode,{children:f.jsx(cv,{})}));
