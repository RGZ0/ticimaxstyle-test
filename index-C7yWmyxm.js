 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var hh;function Xx(){return hh||(hh=1,(function(a){function r(_,Q){var ft=_.length;_.push(Q);t:for(;0<ft;){var bt=ft-1>>>1,S=_[bt];if(0<c(S,Q))_[bt]=Q,_[ft]=S,ft=bt;else break t}}function o(_){return _.length===0?null:_[0]}function u(_){if(_.length===0)return null;var Q=_[0],ft=_.pop();if(ft!==Q){_[0]=ft;t:for(var bt=0,S=_.length,L=S>>>1;bt<L;){var nt=2*(bt+1)-1,q=_[nt],F=nt+1,ot=_[F];if(0>c(q,ft))F<S&&0>c(ot,q)?(_[bt]=ot,_[F]=ft,bt=F):(_[bt]=q,_[nt]=ft,bt=nt);else if(F<S&&0>c(ot,ft))_[bt]=ot,_[F]=ft,bt=F;else break t}}return Q}function c(_,Q){var ft=_.sortIndex-Q.sortIndex;return ft!==0?ft:_.id-Q.id}if(a.unstable_now=void 0,typeof performance=="object"&&typeof performance.now=="function"){var d=performance;a.unstable_now=function(){return d.now()}}else{var p=Date,g=p.now();a.unstable_now=function(){return p.now()-g}}var w=[],x=[],y=1,T=null,z=3,I=!1,k=!1,B=!1,C=!1,W=typeof setTimeout=="function"?setTimeout:null,Y=typeof clearTimeout=="function"?clearTimeout:null,$=typeof setImmediate<"u"?setImmediate:null;function rt(_){for(var Q=o(x);Q!==null;){if(Q.callback===null)u(x);else if(Q.startTime<=_)u(x),Q.sortIndex=Q.expirationTime,r(w,Q);else break;Q=o(x)}}function H(_){if(B=!1,rt(_),!k)if(o(w)!==null)k=!0,et||(et=!0,P());else{var Q=o(x);Q!==null&&yt(H,Q.startTime-_)}}var et=!1,K=-1,lt=5,zt=-1;function Yt(){return C?!0:!(a.unstable_now()-zt<lt)}function Ct(){if(C=!1,et){var _=a.unstable_now();zt=_;var Q=!0;try{t:{k=!1,B&&(B=!1,Y(K),K=-1),I=!0;var ft=z;try{e:{for(rt(_),T=o(w);T!==null&&!(T.expirationTime>_&&Yt());){var bt=T.callback;if(typeof bt=="function"){T.callback=null,z=T.priorityLevel;var S=bt(T.expirationTime<=_);if(_=a.unstable_now(),typeof S=="function"){T.callback=S,rt(_),Q=!0;break e}T===o(w)&&u(w),rt(_)}else u(w);T=o(w)}if(T!==null)Q=!0;else{var L=o(x);L!==null&&yt(H,L.startTime-_),Q=!1}}break t}finally{T=null,z=ft,I=!1}Q=void 0}}finally{Q?P():et=!1}}}var P;if(typeof $=="function")P=function(){$(Ct)};else if(typeof MessageChannel<"u"){var st=new MessageChannel,xt=st.port2;st.port1.onmessage=Ct,P=function(){xt.postMessage(null)}}else P=function(){W(Ct,0)};function yt(_,Q){K=W(function(){_(a.unstable_now())},Q)}a.unstable_IdlePriority=5,a.unstable_ImmediatePriority=1,a.unstable_LowPriority=4,a.unstable_NormalPriority=3,a.unstable_Profiling=null,a.unstable_UserBlockingPriority=2,a.unstable_cancelCallback=function(_){_.callback=null},a.unstable_forceFrameRate=function(_){0>_||125<_?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):lt=0<_?Math.floor(1e3/_):5},a.unstable_getCurrentPriorityLevel=function(){return z},a.unstable_next=function(_){switch(z){case 1:case 2:case 3:var Q=3;break;default:Q=z}var ft=z;z=Q;try{return _()}finally{z=ft}},a.unstable_requestPaint=function(){C=!0},a.unstable_runWithPriority=function(_,Q){switch(_){case 1:case 2:case 3:case 4:case 5:break;default:_=3}var ft=z;z=_;try{return Q()}finally{z=ft}},a.unstable_scheduleCallback=function(_,Q,ft){var bt=a.unstable_now();switch(typeof ft=="object"&&ft!==null?(ft=ft.delay,ft=typeof ft=="number"&&0<ft?bt+ft:bt):ft=bt,_){case 1:var S=-1;break;case 2:S=250;break;case 5:S=1073741823;break;case 4:S=1e4;break;default:S=5e3}return S=ft+S,_={id:y++,callback:Q,priorityLevel:_,startTime:ft,expirationTime:S,sortIndex:-1},ft>bt?(_.sortIndex=ft,r(x,_),o(w)===null&&_===o(x)&&(B?(Y(K),K=-1):B=!0,yt(H,ft-bt))):(_.sortIndex=S,r(w,_),k||I||(k=!0,et||(et=!0,P()))),_},a.unstable_shouldYield=Yt,a.unstable_wrapCallback=function(_){var Q=z;return function(){var ft=z;z=Q;try{return _.apply(this,arguments)}finally{z=ft}}}})(kc)),kc}var ph;function Zx(){return ph||(ph=1,Dc.exports=Xx()),Dc.exports}var Rc={exports:{}},_t={};/**
 * @license React
 * react.production.js
 *
 * Copyright (c) Meta Platforms, Inc. and affiliates.
...
`,My=({mainColor:a,stockReminderUsageChannel:r,forceOpen:o})=>{const u=G.useRef(null),[c,d]=G.useState(o||!1),[p,g]=G.useState(!1),[w,x]=G.useState(""),[y,T]=G.useState(!1),[z,I]=G.useState(),[k,B]=G.useState(),[C,W]=G.useState(!1),[Y,$]=G.useState(!1),[rt,H]=G.useState(null),et=G.useRef(null),K=G.useRef(null),lt=G.useRef(null),zt=()=>{document.querySelectorAll(".nostok").forEach(F=>{if(!F.querySelector(".stock_bell_icon")){const ot=document.createElementNS("http://www.w3.org/2000/svg","svg");ot.setAttribute("class","stock_bell_icon"),ot.setAttribute("height","18"),ot.setAttribute("width","18"),ot.setAttribute("viewBox","0 0 512 512"),ot.style.pointerEvents="none";const ut=document.createElementNS("http://www.w3.org/2000/svg","g");["m437.017 39.687c-5.858-5.857-15.356-5.857-21.213 0-5.858 5.858-5.857 15.356 0 21.213 42.688 42.685 66.196 99.438 66.196 159.807 0 8.284 6.716 15 15 15s15-6.716 15-15c0-68.382-26.629-132.67-74.983-181.02z","m96.193 39.688c-5.858-5.857-15.355-5.858-21.213 0-48.352 48.354-74.98 112.641-74.98 181.019 0 8.284 6.716 15 15 15s15-6.716 15-15c0-60.365 23.508-117.118 66.193-159.805 5.858-5.858 5.858-15.356 0-21.214z","m370.358 85.125c-5.858 5.858-5.857 15.355 0 21.213 30.55 30.548 47.374 71.164 47.374 114.368 0 8.284 6.716 15 15 15s15-6.716 15-15c0-51.217-19.945-99.368-56.161-135.582-5.858-5.856-15.355-5.856-21.213.001z","m141.634 85.132c-5.858-5.857-15.356-5.857-21.213.001-36.211 36.216-56.154 84.363-56.154 135.573 0 8.284 6.716 15 15 15s15-6.716 15-15c0-43.197 16.823-83.811 47.369-114.361 5.857-5.858 5.856-15.355-.002-21.213z","m383.467 329.632v-76.792c0-28.011-8.918-54.59-25.79-76.865-14.101-18.617-33.332-33.16-54.939-41.717-3.007-23.111-22.82-41.018-46.738-41.018s-43.733 17.906-46.74 41.018c-21.606 8.558-40.837 23.101-54.938 41.717-16.872 22.275-25.79 48.854-25.79 76.865v76.792l-30.549 61.1c-2.325 4.65-2.076 10.172.657 14.594s7.561 7.114 12.76 7.114h66.774c7.033 36.558 39.246 64.267 77.825 64.267 38.578 0 70.791-27.709 77.823-64.267h66.778c5.199 0 10.027-2.692 12.76-7.114s2.981-9.944.657-14.594zm-127.467 117.075c-21.938 0-40.573-14.413-46.933-34.267h93.865c-6.36 19.854-24.994 34.267-46.932 34.267zm64.266-64.267h-128.533-56.062l21.279-42.559c1.042-2.083 1.583-4.379 1.583-6.708v-80.333c0-42.793 28.625-81.203 69.612-93.405 6.36-1.894 10.72-7.741 10.72-14.376v-4.686c0-9.447 7.687-17.133 17.135-17.133 9.447 0 17.133 7.686 17.133 17.133v4.686c0 6.636 4.36 12.483 10.72 14.376 40.987 12.202 69.614 50.611 69.614 93.405v80.333c0 2.329.542 4.625 1.583 6.708l21.279 42.559z"].forEach(pt=>{const kt=document.createElementNS("http://www.w3.org/2000/svg","path");kt.setAttribute("d",pt),ut.appendChild(kt)}),ot.appendChild(ut),F.appendChild(ot)}})},Yt=()=>{lt.current&&clearInterval(lt.current),lt.current=setInterval(()=>{document.querySelectorAll(".stock_bell_icon").forEach(F=>{const ot=F;ot.classList.add("bell-animate"),setTimeout(()=>{ot.classList.remove("bell-animate")},1e3)})},3e3)},Ct=()=>{const q=document.getElementById("dynamicNostokBellStyles");q&&q.remove();const F=document.createElement("style");F.id="dynamicNostokBellStyles",F.innerHTML=`
    ...
    `,document.head.appendChild(F)};G.useEffect(()=>{typeof window<"u"&&(window.currentProduct?I(window.currentProduct):window.productDetailModel&&I(window.productDetailModel))},[]),G.useEffect(()=>(Ct(),()=>{const q=document.getElementById("dynamicNostokBellStyles");q&&q.remove()}),[a]),G.useEffect(()=>{typeof window<"u"&&z&&(zt(),Yt())},[z]),G.useEffect(()=>()=>{lt.current&&clearInterval(lt.current)},[]);const{register:P,handleSubmit:st,formState:{errors:xt},reset:yt,clearErrors:_}=br(),Q=()=>{d(!1),B(null),$(!1),H(null),yt(),_(),x(""),W(!1)};u!==null&&nl(u,Q);const ft=st(q=>{g(!0),z&&(z.productVariantData&&!k||qt.post("https://api.upsell.co/phonesubscription/reminder",{...r===1||r===2?{phone:"90"+q.phone,email:""}:{email:q.email,phone:""},productName:z.productName,productSlug:window.location.pathname,productId:`${z.productVariantData?k?.variantOptions[0].urunID:z.product.id}`,productCardId:z.product.urunKartiId.toString(),variant:(JSON.stringify(k)??"{}")||"{}",hasVariant:z.productVariantData!==null}).then(()=>{T(!0),d(!1)}).catch(()=>{x(r===1||r===2?"Bu telefon numarası zaten kayıtlı.":"Bu e-posta adresi zaten kayıtlı.")}).finally(()=>{g(!1)}))});G.useEffect(()=>{if(o)d(!0);else if(typeof window<"u"){const q=gt=>{gt.preventDefault(),gt.stopPropagation();const pt=gt.currentTarget;let kt=pt.getAttribute("data-variant-definition");if(!kt){const ae=pt.querySelector("[data-variant-definition]");ae&&(kt=ae.getAttribute("data-variant-definition"))}H(kt),c||d(!0)},F=()=>{c||d(!0)};et.current=q,K.current=F;const ot=document.getElementById("upsell-ss-reminder");ot&&(ot.removeEventListener("click",K.current),ot.addEventListener("click",F));const ut=document.querySelectorAll(".nostok");if(ut.forEach(gt=>{et.current&&gt.removeEventListener("click",et.current)}),ut.forEach(gt=>{gt.addEventListener("click",q)}),z){const gt=z.productVariantData?.some(ae=>ae.stokAdedi===0),pt=z.productVariantData===null&&z.totalStockAmount===0;if(gt||pt){const ae=z.productVariantData!==null&&z.totalStockAmount===0;if(ut.length===0||ae)if(ot)ot.style.display="flex";else{const ve=()=>{if(typeof window.$<"u"){const St=document.querySelector(".MiddleList");if(St&&!document.getElementById("upsell-ss-reminder")){const vt=`
        ...
        .rank-std { background: #333; }
        .rank-1 { background: linear-gradient(135deg, #FFD700, #FDB931); text-shadow: 0 1px 2px rgba(0,0,0,0.2); font-size: 16px; }
        .rank-2 { background: linear-gradient(135deg, #E0E0E0, #BDBDBD); color: #444; }
        .rank-3 { background: linear-gradient(135deg, #CD7F32, #A0522D); }

        /* Görsel Alanı */
        .bs-image-wrapper {
          position: relative;
          aspect-ratio: 2 / 3; /* Portre mod */
          overflow: hidden;
          background: #f9f9f9;
        }
        ...
        @media (max-width: 768px) {
           ...
           .bs-add-cart i { font-size: 16px; margin: 0; }
        }
      `}}),f.jsx("div",{className:"bs-head-wrap",children:f.jsxs("h2",{className:"bs-heading",children:[f.jsx("i",{className:"fas fa-crown"}),"Kategorinin En Çok Satanları"]})}),f.jsx("div",{ref:d,className:"owl-carousel owl-theme",children:r.map((y,T)=>x(y,T))})]}),p.current)},Uy=J.div`
  position: fixed;
  top: 0;
  left: 0;
  z-index: 9999;
...
`,Jy=({color:a})=>{const[r,o]=G.useState(null),[u,c]=G.useState(!1),[d,p]=G.useState(!1),[g,w]=G.useState(!1),x=G.useRef(null);G.useEffect(()=>{x.current=document.querySelector("#upsell-ss-responsive"),w(!0)},[]);const{register:y,handleSubmit:T,formState:{errors:z}}=br(),I=T(async B=>{p(!0),c(!1),o(null);try{const W=(await qt.post("https://api.upsell.co/ticimax/order",{phone:"90"+B.phone})).data;!W.data||W.data===null?c(!0):o(W.data)}catch{c(!0)}finally{p(!1)}}),k=()=>{o(null),c(!1)};return g&&x.current?Dm.createPortal(f.jsx(Ky,{mainColor:a,children:f.jsxs(bo,{children:[f.jsx(zf,{mainColor:a}),f.jsx(Af,{mainColor:a}),f.jsx(Tf,{mainColor:a}),d&&f.jsx(wr,{children:f.jsx(Qy,{children:Array.from({length:8}).map((B,C)=>f.jsx("div",{},C))})}),r?f.jsxs(Ii,{children:[f.jsx(ai,{mainColor:a,children:"Sipariş Durumunu Sorgula"}),f.jsxs(bn,{children:[f.jsx("div",{style:{width:"50%"},children:"Sipariş No"}),f.jsx("div",{style:{width:"50%"},children:r.siparisNo||"-"})]}),f.jsxs(bn,{children:[f.jsx("div",{style:{width:"50%"},children:"Sipariş Tarihi"}),f.jsx("div",{style:{width:"50%"},children:new Date(r.siparisTarihi).toLocaleDateString("tr-TR")||"-"})]}),f.jsxs(bn,{children:[f.jsx("div",{style:{width:"50%"},children:"Sipariş Durumu"}),f.jsx("div",{style:{width:"50%"},children:r.siparisDurumu||"-"})]}),f.jsxs(bn,{children:[f.jsx("div",{style:{width:"50%"},children:"Kargo Takip Link"}),f.jsx("div",{style:{width:"50%"},children:r.kargoTakipLink?f.jsx("a",{target:"_blank",rel:"noopener noreferrer",style:{textDecoration:"none",color:a||"#e7333c"},href:r.kargoTakipLink,children:"Kargoyu Görüntüle"}):"-"})]}),f.jsxs(bn,{children:[f.jsx("div",{style:{width:"50%"},children:"Kargo Takip No"}),f.jsx("div",{style:{width:"50%"},children:r.kargoTakipNo||"-"})]}),f.jsxs(bn,{children:[f.jsx("div",{style:{width:"50%"},children:"Kargo Firma"}),f.jsx("div",{style:{width:"50%"},children:r.kargoFirmaTanim||"-"})]}),f.jsx("div",{children:f.jsx(hr,{mainColor:a,onClick:k,type:"button",children:"Yeni Sorgu Yap"})})]}):f.jsxs(Ii,{children:[f.jsx(ai,{mainColor:a,children:"Sipariş Durumunu Sorgula"}),f.jsx(Sr,{children:"Siparişinizin kargo takibini yapmak için telefon numaranızı giriniz."}),f.jsxs("form",{onSubmit:I,children:[f.jsx(Ra,{mainColor:a,type:"text",...y("phone",{required:"Telefon numarası boş bırakılamaz",pattern:{value:/^[0-9]{10}$/,message:"Geçerli bir telefon numarası giriniz"}}),placeholder:"5XXXXXXXXX",maxLength:10}),z.phone&&f.jsx(De,{children:f.jsx("div",{style:{color:"red",fontSize:"14px",textAlign:"center"},children:z.phone.message})}),f.jsxs(go,{children:[f.jsx(xo,{mainColor:a,...y("kvkk",{required:"Lütfen bilgilerinizi paylaşmak için onay veriniz"}),type:"checkbox"}),f.jsxs("p",{style:{fontSize:"13px",lineHeight:"1.4",margin:0,color:"#666"},children:["Kampanya, duyuru ve bilgilendirmelerden E-Posta, WhatsApp ve SMS yoluyla haberdar olmak istediğimi belirtiyorum."," ",f.jsx("a",{style:{color:a||"#e7333c",textDecoration:"underline",fontWeight:"500"},href:"/UyelikSozlesme.aspx?sozlemeTipi=5",target:"_blank",rel:"noopener noreferrer",children:"Aydınlatma metni için tıklayın."})]})]}),z.kvkk&&f.jsx(De,{children:f.jsx("div",{style:{color:"red",fontSize:"14px",textAlign:"center",marginBottom:"10px"},children:z.kvkk.message})}),u&&f.jsx(De,{children:f.jsx("div",{style:{color:"red",fontSize:"14px",textAlign:"center"},children:"Telefon numarası ile eşleşen sipariş bulunamadı."})}),f.jsx("div",{children:f.jsx(hr,{mainColor:a,children:"Sorgula"})})]})]})]})}),x.current):null},Fy=Ie`
  0% {
    transform: rotate(0deg);
  }
  100% {
