...
`,My=({mainColor:a,stockReminderUsageChannel:r,forceOpen:o})=>{const u=G.useRef(null),[c,d]=G.useState(o||!1),[p,g]=G.useState(!1),[w,x]=G.useState(""),[y,T]=G.useState(!1),[z,J]=G.useState(),[k,q]=G.useState(),[M,P]=G.useState(!1),[Y,$]=G.useState(!1),[rt,B]=G.useState(null),et=G.useRef(null),K=G.useRef(null),lt=G.useRef(null),zt=()=>{document.querySelectorAll(".nostok").forEach(F=>{if(!F.querySelector(".stock_bell_icon")){const ot=document.createElementNS("http://www.w3.org/2000/svg","svg");ot.setAttribute("class","stock_bell_icon"),ot.setAttribute("height","18"),ot.setAttribute("width","18"),ot.setAttribute("viewBox","0 0 512 512"),ot.style.pointerEvents="none";const ut=document.createElementNS("http://www.w3.org/2000/svg","g");["m437.017 39.687c-5.858-5.857-15.356-5.857-21.213 0-5.858 5.858-5.857 15.356 0 21.213 42.688 42.685 66.196 99.438 66.196 159.807 0 8.284 6.716 15 15 15s15-6.716 15-15c0-68.382-26.629-132.67-74.983-181.02z","m96.193 39.688c-5.858-5.857-15.355-5.858-21.213 0-48.352 48.354-74.98 112.641-74.98 181.019 0 8.284 6.716 15 15 15s15-6.716 15-15c0-60.365 23.508-117.118 66.193-159.805 5.858-5.858 5.858-15.356 0-21.214z","m370.358 85.125c-5.858 5.858-5.857 15.355 0 21.213 30.55 30.548 47.374 71.164 47.374 114.368 0 8.284 6.716 15 15 15s15-6.716 15-15c0-51.217-19.945-99.368-56.161-135.582-5.858-5.856-15.355-5.856-21.213.001z","m141.634 85.132c-5.858-5.857-15.356-5.857-21.213.001-36.211 36.216-56.154 84.363-56.154 135.573 0 8.284 6.716 15 15 15s15-6.716 15-15c0-43.197 16.823-83.811 47.369-114.361 5.857-5.858 5.856-15.355-.002-21.213z","m383.467 329.632v-76.792c0-28.011-8.918-54.59-25.79-76.865-14.101-18.617-33.332-33.16-54.939-41.717-3.007-23.111-22.82-41.018-46.738-41.018s-43.733 17.906-46.74 41.018c-21.606 8.558-40.837 23.101-54.938 41.717-16.872 22.275-25.79 48.854-25.79 76.865v76.792l-30.549 61.1c-2.325 4.65-2.076 10.172.657 14.594s7.561 7.114 12.76 7.114h66.774c7.033 36.558 39.246 64.267 77.825 64.267 38.578 0 70.791-27.709 77.823-64.267h66.778c5.199 0 10.027-2.692 12.76-7.114s2.981-9.944.657-14.594zm-127.467 117.075c-21.938 0-40.573-14.413-46.933-34.267h93.865c-6.36 19.854-24.994 34.267-46.932 34.267zm64.266-64.267h-128.533-56.062l21.279-42.559c1.042-2.083 1.583-4.379 1.583-6.708v-80.333c0-42.793 28.625-81.203 69.612-93.405 6.36-1.894 10.72-7.741 10.72-14.376v-4.686c0-9.447 7.687-17.133 17.135-17.133 9.447 0 17.133 7.686 17.133 17.133v4.686c0 6.636 4.36 12.483 10.72 14.376 40.987 12.202 69.614 50.611 69.614 93.405v80.333c0 2.329.542 4.625 1.583 6.708l21.279 42.559z"].forEach(pt=>{const kt=document.createElementNS("http://www.w3.org/2000/svg","path");kt.setAttribute("d",pt),ut.appendChild(kt)}),ot.appendChild(ut),F.appendChild(ot)}})},Yt=()=>{lt.current&&clearInterval(lt.current),lt.current=setInterval(()=>{document.querySelectorAll(".stock_bell_icon").forEach(F=>{const ot=F;ot.classList.add("bell-animate"),setTimeout(()=>{ot.classList.remove("bell-animate")},1e3)})},3e3)},Ct=()=>{const L=document.getElementById("dynamicNostokBellStyles");L&&L.remove();const F=document.createElement("style");F.id="dynamicNostokBellStyles",F.innerHTML=`
    ...
    `,document.head.appendChild(F)};G.useEffect(()=>{typeof window<"u"&&(window.currentProduct?J(window.currentProduct):window.productDetailModel&&J(window.productDetailModel))},[]),G.useEffect(()=>(Ct(),()=>{const L=document.getElementById("dynamicNostokBellStyles");L&&L.remove()}),[a]),G.useEffect(()=>{typeof window<"u"&&z&&(zt(),Yt())},[z]),G.useEffect(()=>()=>{lt.current&&clearInterval(lt.current)},[]);const{register:I,handleSubmit:st,formState:{errors:xt},reset:yt,clearErrors:_}=br(),Q=()=>{d(!1),q(null),$(!1),B(null),yt(),_(),x(""),P(!1)};u!==null&&nl(u,Q);const ft=st(L=>{g(!0),z&&(z.productVariantData&&!k||qt.post("https://api.upsell.co/phonesubscription/reminder",{...r===1||r===2?{phone:"90"+L.phone,email:""}:{email:L.email,phone:""},productName:z.productName,productSlug:window.location.pathname,productId:`${z.productVariantData?k?.variantOptions[0].urunID:z.product.id}`,productCardId:z.product.urunKartiId.toString(),variant:(JSON.stringify(k)??"{}")||"{}",hasVariant:z.productVariantData!==null}).then(()=>{T(!0),d(!1)}).catch(()=>{x(r===1||r===2?"Bu telefon numarası zaten kayıtlı.":"Bu e-posta adresi zaten kayıtlı.")}).finally(()=>{g(!1)}))});G.useEffect(()=>{if(o)d(!0);else if(typeof window<"u"){const L=gt=>{gt.preventDefault(),gt.stopPropagation();const pt=gt.currentTarget;let kt=pt.getAttribute("data-variant-definition");if(!kt){const ae=pt.querySelector("[data-variant-definition]");ae&&(kt=ae.getAttribute("data-variant-definition"))}B(kt),c||d(!0)},F=()=>{c||d(!0)};et.current=L,K.current=F;const ot=document.getElementById("upsell-ss-reminder");ot&&(ot.removeEventListener("click",K.current),ot.addEventListener("click",F));const ut=document.querySelectorAll(".nostok");if(ut.forEach(gt=>{et.current&&gt.removeEventListener("click",et.current)}),ut.forEach(gt=>{gt.addEventListener("click",L)}),z){const gt=z.productVariantData?.some(ae=>ae.stokAdedi===0),pt=z.productVariantData===null&&z.totalStockAmount===0;if(gt||pt){const ae=z.productVariantData!==null&&z.totalStockAmount===0;if(ut.length===0||ae)if(ot)ot.style.display="flex";else{const ve=()=>{if(typeof window.$<"u"){const St=document.querySelector(".MiddleList");if(St&&!document.getElementById("upsell-ss-reminder")){const vt=`
        ...
        /* Butonların Kenarlara Yaslanması */
        .bs-widget-container .owl-prev {
            position: absolute;
            left: -20px;
        }
        .bs-widget-container .owl-next {
            position: absolute;
            right: -20px;
        }
      ...
      `}}),f.jsx("div",{className:"bs-head-wrap",children:f.jsxs("h2",{className:"bs-heading",children:[f.jsxs("svg",{xmlns:"http://www.w3.org/2000/svg",width:"24",height:"24",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor","stroke-width":"2","stroke-linecap":"round","stroke-linejoin":"round",children:[f.jsx("path",{d:"M6 9H4.5a2.5 2.5 0 0 1 0-5H6"}),f.jsx("path",{d:"M18 9h1.5a2.5 2.5 0 0 0 0-5H18"}),f.jsx("path",{d:"M4 22h16"}),f.jsx("path",{d:"M10 14.66V17c0 .55-.47.98-.97 1.21C7.85 18.75 7 20.24 7 22"}),f.jsx("path",{d:"M14 14.66V17c0 .55.47.98.97 1.21C16.15 18.75 17 20.24 17 22"}),f.jsx("path",{d:"M18 2H6v7a6 6 0 0 0 12 0V2Z"})]}),"Kategorinin En Çok Satanları"]})}),f.jsx("div",{ref:d,className:"owl-carousel owl-theme",children:r.map(y=>x(y))})]}),p.current)},Uy=W.div`
  position: fixed;
  top: 0;
  left: 0;
  z-index: 9999;
