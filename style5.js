 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var hh;function Xx(){return hh||(hh=1,(function(a){function r(_,Q){var ft=_.length;_.push(Q);t:for(;0<ft;){var vt=ft-1>>>1,w=_[vt];if(0<c(w,Q))_[vt]=Q,_[ft]=w,ft=vt;else break t}}function o(_){return _.length===0?null:_[0]}function u(_){if(_.length===0)return null;var Q=_[0],ft=_.pop();if(ft!==Q){_[0]=ft;t:for(var vt=0,w=_.length,q=w>>>1;vt<q;){var nt=2*(vt+1)-1,V=_[nt],I=nt+1,ot=_[I];if(0>c(V,ft))I<w&&0>c(ot,V)?(_[vt]=ot,_[I]=ft,vt=I):(_[vt]=V,_[nt]=ft,vt=nt);else if(I<w&&0>c(ot,ft))_[vt]=ot,_[I]=ft,vt=I;else break t}}return Q}function c(_,Q){var ft=_.sortIndex-Q.sortIndex;return ft!==0?ft:_.id-Q.id}if(a.unstable_now=void 0,typeof performance=="object"&&typeof performance.now=="function"){var d=performance;a.unstable_now=function(){return d.now()}}else{var p=Date,g=p.now();a.unstable_now=function(){return p.now()-g}}var S=[],x=[],v=1,E=null,A=3,F=!1,C=!1,B=!1,k=!1,J=typeof setTimeout=="function"?setTimeout:null,L=typeof clearTimeout=="function"?clearTimeout:null,$=typeof setImmediate<"u"?setImmediate:null;function rt(_){for(var Q=o(x);Q!==null;){if(Q.callback===null)u(x);else if(Q.startTime<=_)u(x),Q.sortIndex=Q.expirationTime,r(S,Q);else break;Q=o(x)}}function H(_){if(B=!1,rt(_),!C)if(o(S)!==null)C=!0,et||(et=!0,P());else{var Q=o(x);Q!==null&&yt(H,Q.startTime-_)}}var et=!1,K=-1,lt=5,zt=-1;function Yt(){return k?!0:!(a.unstable_now()-zt<lt)}function Rt(){if(k=!1,et){var _=a.unstable_now();zt=_;var Q=!0;try{t:{C=!1,B&&(B=!1,L(K),K=-1),F=!0;var ft=A;try{e:{for(rt(_),E=o(S);E!==null&&!(E.expirationTime>_&&Yt());){var vt=E.callback;if(typeof vt=="function"){E.callback=null,A=E.priorityLevel;var w=vt(E.expirationTime<=_);if(_=a.unstable_now(),typeof w=="function"){E.callback=w,rt(_),Q=!0;break e}E===o(S)&&u(S),rt(_)}else u(S);E=o(S)}if(E!==null)Q=!0;else{var q=o(x);q!==null&&yt(H,q.startTime-_),Q=!1}}break t}finally{E=null,A=ft,F=!1}Q=void 0}}finally{Q?P():et=!1}}}var P;if(typeof $=="function")P=function(){$(Rt)};else if(typeof MessageChannel<"u"){var st=new MessageChannel,xt=st.port2;st.port1.onmessage=Rt,P=function(){xt.postMessage(null)}}else P=function(){J(Rt,0)};function yt(_,Q){K=J(function(){_(a.unstable_now())},Q)}a.unstable_IdlePriority=5,a.unstable_ImmediatePriority=1,a.unstable_LowPriority=4,a.unstable_NormalPriority=3,a.unstable_Profiling=null,a.unstable_UserBlockingPriority=2,a.unstable_cancelCallback=function(_){_.callback=null},a.unstable_forceFrameRate=function(_){0>_||125<_?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):lt=0<_?Math.floor(1e3/_):5},a.unstable_getCurrentPriorityLevel=function(){return A},a.unstable_next=function(_){switch(A){case 1:case 2:case 3:var Q=3;break;default:Q=A}var ft=A;A=Q;try{return _()}finally{A=ft}},a.unstable_requestPaint=function(){k=!0},a.unstable_runWithPriority=function(_,Q){switch(_){case 1:case 2:case 3:case 4:case 5:break;default:_=3}var ft=A;A=_;try{return Q()}finally{A=ft}},a.unstable_scheduleCallback=function(_,Q,ft){var vt=a.unstable_now();switch(typeof ft=="object"&&ft!==null?(ft=ft.delay,ft=typeof ft=="number"&&0<ft?vt+ft:vt):ft=vt,_){case 1:var w=-1;break;case 2:w=250;break;case 5:w=1073741823;break;case 4:w=1e4;break;default:w=5e3}return w=ft+w,_={id:v++,callback:Q,priorityLevel:_,startTime:ft,expirationTime:w,sortIndex:-1},ft>vt?(_.sortIndex=ft,r(x,_),o(S)===null&&_===o(x)&&(B?(L(K),K=-1):B=!0,yt(H,ft-vt))):(_.sortIndex=w,r(S,_),C||F||(C=!0,et||(et=!0,P()))),_},a.unstable_shouldYield=Yt,a.unstable_wrapCallback=function(_){var Q=A;return function(){var ft=A;A=Q;try{return _.apply(this,arguments)}finally{A=ft}}}})(Cc)),Cc}var ph;function Zx(){return ph||(ph=1,Oc.exports=Xx()),Oc.exports}var kc={exports:{}},_t={};/**
 * @license React
 * react.production.js
 *
 * Copyright (c) Meta Platforms, Inc. and affiliates.
...
`,Ny=({mainColor:a,stockReminderUsageChannel:r,forceOpen:o})=>{const u=G.useRef(null),[c,d]=G.useState(o||!1),[p,g]=G.useState(!1),[S,x]=G.useState(""),[v,E]=G.useState(!1),[A,F]=G.useState(),[C,B]=G.useState(),[k,J]=G.useState(!1),[L,$]=G.useState(!1),[rt,H]=G.useState(null),et=G.useRef(null),K=G.useRef(null),lt=G.useRef(null),zt=()=>{document.querySelectorAll(".nostok").forEach(I=>{if(!I.querySelector(".stock_bell_icon")){const ot=document.createElementNS("http://www.w3.org/2000/svg","svg");ot.setAttribute("class","stock_bell_icon"),ot.setAttribute("height","18"),ot.setAttribute("width","18"),ot.setAttribute("viewBox","0 0 512 512"),ot.style.pointerEvents="none";const ut=document.createElementNS("http://www.w3.org/2000/svg","g");["m437.017 39.687c-5.858-5.857-15.356-5.857-21.213 0-5.858 5.858-5.857 15.356 0 21.213 42.688 42.685 66.196 99.438 66.196 159.807 0 8.284 6.716 15 15 15s15-6.716 15-15c0-68.382-26.629-132.67-74.983-181.02z","m96.193 39.688c-5.858-5.857-15.355-5.858-21.213 0-48.352 48.354-74.98 112.641-74.98 181.019 0 8.284 6.716 15 15 15s15-6.716 15-15c0-60.365 23.508-117.118 66.193-159.805 5.858-5.858 5.858-15.356 0-21.214z","m370.358 85.125c-5.858 5.858-5.857 15.355 0 21.213 30.55 30.548 47.374 71.164 47.374 114.368 0 8.284 6.716 15 15 15s15-6.716 15-15c0-51.217-19.945-99.368-56.161-135.582-5.858-5.856-15.355-5.856-21.213.001z","m141.634 85.132c-5.858-5.857-15.356-5.857-21.213.001-36.211 36.216-56.154 84.363-56.154 135.573 0 8.284 6.716 15 15 15s15-6.716 15-15c0-43.197 16.823-83.811 47.369-114.361 5.857-5.858 5.856-15.355-.002-21.213z","m383.467 329.632v-76.792c0-28.011-8.918-54.59-25.79-76.865-14.101-18.617-33.332-33.16-54.939-41.717-3.007-23.111-22.82-41.018-46.738-41.018s-43.733 17.906-46.74 41.018c-21.606 8.558-40.837 23.101-54.938 41.717-16.872 22.275-25.79 48.854-25.79 76.865v76.792l-30.549 61.1c-2.325 4.65-2.076 10.172.657 14.594s7.561 7.114 12.76 7.114h66.774c7.033 36.558 39.246 64.267 77.825 64.267 38.578 0 70.791-27.709 77.823-64.267h66.778c5.199 0 10.027-2.692 12.76-7.114s2.981-9.944.657-14.594zm-127.467 117.075c-21.938 0-40.573-14.413-46.933-34.267h93.865c-6.36 19.854-24.994 34.267-46.932 34.267zm64.266-64.267h-128.533-56.062l21.279-42.559c1.042-2.083 1.583-4.379 1.583-6.708v-80.333c0-42.793 28.625-81.203 69.612-93.405 6.36-1.894 10.72-7.741 10.72-14.376v-4.686c0-9.447 7.687-17.133 17.135-17.133 9.447 0 17.133 7.686 17.133 17.133v4.686c0 6.636 4.36 12.483 10.72 14.376 40.987 12.202 69.614 50.611 69.614 93.405v80.333c0 2.329.542 4.625 1.583 6.708l21.279 42.559z"].forEach(pt=>{const Ct=document.createElementNS("http://www.w3.org/2000/svg","path");Ct.setAttribute("d",pt),ut.appendChild(Ct)}),ot.appendChild(ut),I.appendChild(ot)}})},Yt=()=>{lt.current&&clearInterval(lt.current),lt.current=setInterval(()=>{document.querySelectorAll(".stock_bell_icon").forEach(I=>{const ot=I;ot.classList.add("bell-animate"),setTimeout(()=>{ot.classList.remove("bell-animate")},1e3)})},3e3)},Rt=()=>{const V=document.getElementById("dynamicNostokBellStyles");V&&V.remove();const I=document.createElement("style");I.id="dynamicNostokBellStyles",I.innerHTML=`
    ...
    `,document.head.appendChild(I)};G.useEffect(()=>{typeof window<"u"&&(window.currentProduct?F(window.currentProduct):window.productDetailModel&&F(window.productDetailModel))},[]),G.useEffect(()=>(Rt(),()=>{const V=document.getElementById("dynamicNostokBellStyles");V&&V.remove()}),[a]),G.useEffect(()=>{typeof window<"u"&&A&&(zt(),Yt())},[A]),G.useEffect(()=>()=>{lt.current&&clearInterval(lt.current)},[]);const{register:P,handleSubmit:st,formState:{errors:xt},reset:yt,clearErrors:_}=vr(),Q=()=>{d(!1),B(null),$(!1),H(null),yt(),_(),x(""),J(!1)};u!==null&&nl(u,Q);const ft=st(V=>{g(!0),A&&(A.productVariantData&&!C||qt.post("https://api.upsell.co/phonesubscription/reminder",{...r===1||r===2?{phone:"90"+V.phone,email:""}:{email:V.email,phone:""},productName:A.productName,productSlug:window.location.pathname,productId:`${A.productVariantData?C?.variantOptions[0].urunID:A.product.id}`,productCardId:A.product.urunKartiId.toString(),variant:(JSON.stringify(C)??"{}")||"{}",hasVariant:A.productVariantData!==null}).then(()=>{E(!0),d(!1)}).catch(()=>{x(r===1||r===2?"Bu telefon numarası zaten kayıtlı.":"Bu e-posta adresi zaten kayıtlı.")}).finally(()=>{g(!1)}))});G.useEffect(()=>{if(o)d(!0);else if(typeof window<"u"){const V=gt=>{gt.preventDefault(),gt.stopPropagation();const pt=gt.currentTarget;let Ct=pt.getAttribute("data-variant-definition");if(!Ct){const ae=pt.querySelector("[data-variant-definition]");ae&&(Ct=ae.getAttribute("data-variant-definition"))}H(Ct),c||d(!0)},I=()=>{c||d(!0)};et.current=V,K.current=I;const ot=document.getElementById("upsell-ss-reminder");ot&&(ot.removeEventListener("click",K.current),ot.addEventListener("click",I));const ut=document.querySelectorAll(".nostok");if(ut.forEach(gt=>{et.current&&gt.removeEventListener("click",et.current)}),ut.forEach(gt=>{gt.addEventListener("click",V)}),A){const gt=A.productVariantData?.some(ae=>ae.stokAdedi===0),pt=A.productVariantData===null&&A.totalStockAmount===0;if(gt||pt){const ae=A.productVariantData!==null&&A.totalStockAmount===0;if(ut.length===0||ae)if(ot)ot.style.display="flex";else{const be=()=>{if(typeof window.$<"u"){const St=document.querySelector(".MiddleList");if(St&&!document.getElementById("upsell-ss-reminder")){const bt=`
...
`,Jy=({color:a})=>{const[r,o]=G.useState(null),[u,c]=G.useState(!1),[d,p]=G.useState(!1),[g,S]=G.useState(!1),x=G.useRef(null);G.useEffect(()=>{x.current=document.querySelector("#upsell-ss-responsive"),S(!0)},[]);const{register:v,handleSubmit:E,formState:{errors:A}}=vr(),F=E(async B=>{p(!0),c(!1),o(null);try{const J=(await qt.post("https://api.upsell.co/ticimax/order",{phone:"90"+B.phone})).data;!J.data||J.data===null?c(!0):o(J.data)}catch{c(!0)}finally{p(!1)}}),C=()=>{o(null),c(!1)};return g&&x.current?Om.createPortal(f.jsx(Ky,{mainColor:a,children:f.jsxs(vo,{children:[f.jsx(zf,{mainColor:a}),f.jsx(Af,{mainColor:a}),f.jsx(Tf,{mainColor:a}),d&&f.jsx(wr,{children:f.jsx(Qy,{children:Array.from({length:8}).map((B,k)=>f.jsx("div",{},k))})}),r?f.jsxs(Ii,{children:[f.jsx(ai,{mainColor:a,children:"Sipariş Durumunu Sorgula"}),f.jsxs(vn,{children:[f.jsx("div",{style:{width:"50%"},children:"Sipariş No"}),f.jsx("div",{style:{width:"50%"},children:r.siparisNo||"-"})]}),f.jsxs(vn,{children:[f.jsx("div",{style:{width:"50%"},children:"Sipariş Tarihi"}),f.jsx("div",{style:{width:"50%"},children:new Date(r.siparisTarihi).toLocaleDateString("tr-TR")||"-"})]}),f.jsxs(vn,{children:[f.jsx("div",{style:{width:"50%"},children:"Sipariş Durumu"}),f.jsx("div",{style:{width:"50%"},children:r.siparisDurumu||"-"})]}),f.jsxs(vn,{children:[f.jsx("div",{style:{width:"50%"},children:"Kargo Takip Link"}),f.jsx("div",{style:{width:"50%"},children:r.kargoTakipLink?f.jsx("a",{target:"_blank",rel:"noopener noreferrer",style:{textDecoration:"none",color:a||"#e7333c"},href:r.kargoTakipLink,children:"Kargoyu Görüntüle"}):"-"})]}),f.jsxs(vn,{children:[f.jsx("div",{style:{width:"50%"},children:"Kargo Takip No"}),f.jsx("div",{style:{width:"50%"},children:r.kargoTakipNo||"-"})]}),f.jsxs(vn,{children:[f.jsx("div",{style:{width:"50%"},children:"Kargo Firma"}),f.jsx("div",{style:{width:"50%"},children:r.kargoFirmaTanim||"-"})]}),f.jsx("div",{children:f.jsx(hr,{mainColor:a,onClick:C,type:"button",children:"Yeni Sorgu Yap"})})]}):f.jsxs(Ii,{children:[f.jsx(ai,{mainColor:a,children:"Sipariş Durumunu Sorgula"}),f.jsx(Sr,{children:"Siparişinizin kargo takibini yapmak için telefon numaranızı giriniz."}),f.jsxs("form",{onSubmit:F,children:[f.jsx(ka,{mainColor:a,type:"text",...v("phone",{required:"Telefon numarası boş bırakılamaz",pattern:{value:/^[0-9]{10}$/,message:"Geçerli bir telefon numarası giriniz"}}),placeholder:"5XXXXXXXXX",maxLength:10}),A.phone&&f.jsx(Oe,{children:f.jsx("div",{style:{color:"red",fontSize:"14px",textAlign:"center"},children:A.phone.message})}),f.jsxs(go,{children:[f.jsx(xo,{mainColor:a,...v("kvkk",{required:"Lütfen bilgilerinizi paylaşmak için onay veriniz"}),type:"checkbox"}),f.jsxs("p",{style:{fontSize:"13px",lineHeight:"1.4",margin:0,color:"#666"},children:["Kampanya, duyuru ve bilgilendirmelerden E-Posta, WhatsApp ve SMS yoluyla haberdar olmak istediğimi belirtiyorum."," ",f.jsx("a",{style:{color:a||"#e7333c",textDecoration:"underline",fontWeight:"500"},href:"/UyelikSozlesme.aspx?sozlemeTipi=5",target:"_blank",rel:"noopener noreferrer",children:"Aydınlatma metni için tıklayın."})]})]}),A.kvkk&&f.jsx(Oe,{children:f.jsx("div",{style:{color:"red",fontSize:"14px",textAlign:"center",marginBottom:"10px"},children:A.kvkk.message})}),u&&f.jsx(Oe,{children:f.jsx("div",{style:{color:"red",fontSize:"14px",textAlign:"center"},children:"Telefon numarası ile eşleşen sipariş bulunamadı."})}),f.jsx("div",{children:f.jsx(hr,{mainColor:a,children:"Sorgula"})})]})]})]})}),x.current):null},Fy=Ie`
  0% {
    transform: rotate(0deg);
  }
  100% {
...
`,hv=({mainColor:a,logo:r,forceOpen:o,showFloatingButton:u=!0})=>{const[c,d]=G.useState(o||!1),[p,g]=G.useState(null),[S,x]=G.useState(""),[v,E]=G.useState(!1),[A,F]=G.useState([]),[C,B]=G.useState(0),[k,J]=G.useState(null),[L,$]=G.useState(!1),[rt,H]=G.useState(0),[et,K]=G.useState(!1),[lt,zt]=G.useState(null),[Yt,Rt]=G.useState(!1),[P,st]=G.useState(!0),[xt,yt]=G.useState(null),_=G.useRef(null),{register:Q,handleSubmit:ft,formState:{errors:vt}}=vr(),w=()=>{d(!1);const St=new Date;St.setDate(St.getDate()+Number(rt));const bt="expires="+St.toUTCString();document.cookie=`upsellGiftWheel=false;${bt};path=/`},q=()=>{const St=localStorage.getItem("upsellGiftWheelPrize");if(!St)return!0;try{const bt=JSON.parse(St);if(!bt.timestamp)return!0;const Bt=Date.now(),Lt=bt.timestamp,xe=1440*60*1e3;return Bt-Lt>xe}catch{return!0}},nt=()=>q()?(localStorage.removeItem("upsellGiftWheelPrize"),g(null),yt(null),!0):!1,V=async()=>{if(st(!1),x(""),nt(),(p||xt)&&!q()){E(!0),d(!0);return}const St=localStorage.getItem("upsellGiftWheelPrize");if(St&&!q())try{const bt=JSON.parse(St);yt(bt),g(bt),E(!0),d(!0);return}catch{localStorage.removeItem("upsellGiftWheelPrize")}E(!1),g(null),yt(null),d(!0),A.length===0?be():setTimeout(()=>{pt()},50)};_!==null&&nl(_,()=>w());const ot=async St=>{try{await navigator.clipboard.writeText(St),Rt(!0),setTimeout(()=>Rt(!1),2e3)}catch{}},ut=(St,bt,Bt,Lt)=>{const xe=Lt*Math.PI/180;return{x:St+Bt*Math.cos(xe),y:bt+Bt*Math.sin(xe)}},gt=(St,bt=4e3)=>{if(!k)return;const Bt=Date.now(),Lt=C,xe=St,ie=1800,_n=.985,Pe=10;let b=ie,j=Lt,U=Bt;const it=()=>{const tt=Date.now(),ct=(tt-U)/1e3;U=tt,b*=Math.pow(_n,ct*60);const At=b*ct;j+=At;const jt=Math.min((tt-Bt)/bt,1),Ve=1-Math.pow(1-jt,3),He=Math.pow(jt,2),ra=j,Se=Lt+(xe-Lt)*Ve,Sn=ra*(1-He)+Se*He;if(k.style.transform=`rotate(${Sn}deg)`,b>500){const Ce=Math.min(b/200,3);k.style.filter=`blur(${Ce}px)`}else k.style.filter="none";if(jt<1&&b>Pe){const Ce=requestAnimationFrame(it);zt(Ce)}else k.style.transform=`rotate(${xe}deg)`,k.style.filter="none",B(xe),zt(null),setTimeout(()=>{E(!0)},500)},at=requestAnimationFrame(it);zt(at)},pt=()=>{const St=document.querySelector(".sectors"),bt=document.querySelector(".gift-wheel-texts");if(!St||!bt){setTimeout(()=>{const Bt=document.querySelector(".sectors"),Lt=document.querySelector(".gift-wheel-texts");Bt&&Lt&&Ct(Bt,Lt)},100);return}Ct(St,bt)},Ct=(St,bt)=>{St.innerHTML="",bt.innerHTML="";const Bt=200,Lt=200,xe=170,ie=50,_n=360/A.length;A.forEach((Pe,b)=>{const j=b*_n,U=j+_n,it=j+_n/2,at=ut(Bt,Lt,xe,U),tt=ut(Bt,Lt,xe,j),ct=ut(Bt,Lt,ie,U),At=ut(Bt,Lt,ie,j),jt=U-j<=180?0:1,Zt=`M${ct.x},${ct.y} L${at.x},${at.y} A${xe},${xe} 0 ${jt} 0 ${tt.x},${tt.y} L${At.x},${At.y} A${ie},${ie} 0 ${jt} 1 ${ct.x},${ct.y} Z`,Ve=document.createElementNS("http://www.w3.org/2000/svg","path");Ve.setAttribute("d",Zt);const He=Pe.color||(b%2===0?a||"#e7333c":"#ffffff");Ve.setAttribute("fill",He),Ve.setAttribute("stroke","#fff"),Ve.setAttribute("stroke-width","10"),St.appendChild(Ve);const ra=(xe+ie)/2,Se=ut(Bt,Lt,ra,it),Ce=(On=>{const Ye=On.split(/\n/),un=[],li=_n/360*2*Math.PI*ra*.8,Vn=Math.floor(li/9);return Vn<=0?Ye:(Ye.forEach(zr=>{const bo=zr.split(/\s+/),Ge=[];let Kt="";bo.forEach(oe=>{const Yn=Kt?`${Kt} ${oe}`:oe;if(oe.length>Vn){Kt&&(Ge.push(Kt),Kt="");for(let sa=0;sa<oe.length;sa+=Vn)Ge.push(oe.substring(sa,sa+Vn))}else Yn.length<=Vn?Kt=Yn:(Kt&&Ge.push(Kt),Kt=oe)}),Kt&&Ge.push(Kt),un.push(...Ge)}),un.length>0?un:[On])})(Pe.text),we=document.createElementNS("http://www.w3.org/2000/svg","text");we.setAttribute("x",Se.x.toString()),we.setAttribute("y",Se.y.toString()),we.setAttribute("text-anchor","middle"),we.setAttribute("dominant-baseline","middle"),we.setAttribute("font-size","16"),we.setAttribute("font-weight","700");const qn=On=>{const Ye=On.replace("#",""),un=parseInt(Ye.substr(0,2),16),il=parseInt(Ye.substr(2,2),16),li=parseInt(Ye.substr(4,2),16);return(un*299+il*587+li*114)/1e3>128?"#000":"#fff"},ii=Pe.color?qn(Pe.color):b%2===0?"#fff":"#333";we.setAttribute("fill",ii),we.setAttribute("transform",`rotate(${it} ${Se.x} ${Se.y})`);const al=18,Er=Ce.length>1?Se.y-(Ce.length-1)*al/2:Se.y;Ce.forEach((On,Ye)=>{const un=document.createElementNS("http://www.w3.org/2000/svg","tspan");un.setAttribute("x",Se.x.toString()),un.setAttribute("y",(Er+Ye*al).toString()),un.textContent=On,we.appendChild(un)}),bt.appendChild(we)})},ae=ft(async St=>{L||et||($(!0),K(!0),x(""),await qt.post("https://api.upsell.co/GiftWheel/Spin",{phoneNumber:St.phone}).then(bt=>{var Bt=bt.data;if(Bt.success){const Lt=Bt.data.sliceIndex;if(typeof Lt=="number"&&!isNaN(Lt)){const ie=360/A.length,b=((360-(Lt*ie+ie/2))%360+360)%360,j=C+360*5+b;k&&(lt&&(cancelAnimationFrame(lt),zt(null)),k.style.transformOrigin="200px 200px",k.style.transition="none",k.style.webkitTransition="none",gt(j,4e3)),g(bt.data.data),yt(bt.data.data);const U={...bt.data.data,timestamp:Date.now()};localStorage.setItem("upsellGiftWheelPrize",JSON.stringify(U));const it=new Date;it.setDate(it.getDate()+rt);const at="expires="+it.toUTCString();document.cookie=`upsellGiftWheel=true;${at};path=/`}else x("Sunucudan geçersiz veri alındı.")}else x(Bt.message)}).catch(()=>{x("Bağlantı hatası oluştu. Lütfen tekrar deneyiniz.")}).finally(()=>{setTimeout(()=>{$(!1),K(!1)},4500)}))}),be=async()=>{try{const bt=(await qt.post("https://api.upsell.co/GiftWheel/Slices",{})).data;bt.success?(F(bt.data.slices),H(bt.data.frequency)):x("Hediye çarkı yüklenemedi.")}catch{x("Bağlantı hatası oluştu. Lütfen tekrar deneyiniz.")}};return G.useEffect(()=>{be(),nt()},[]),G.useEffect(()=>{A.length>0&&c&&setTimeout(()=>{pt()},100)},[A,c]),G.useEffect(()=>{if(k&&!L&&!et){k.style.transition="transform 2s ease-in-out";const bt=setInterval(()=>{if(!L&&!et&&k){const Bt=C+Math.sin(Date.now()/3e3)*.5;k.style.transform=`rotate(${Bt}deg)`}},100);return()=>{clearInterval(bt),k&&(k.style.transition="none",k.style.transform=`rotate(${C}deg)`)}}},[k,L,et,C]),G.useEffect(()=>{if(o)(async()=>{nt();const bt=localStorage.getItem("upsellGiftWheelPrize");if(bt&&!q()||(p||xt)&&!q()){if(bt&&!p&&!xt&&!q())try{const Lt=JSON.parse(bt);yt(Lt),g(Lt)}catch{localStorage.removeItem("upsellGiftWheelPrize"),E(!1),g(null),yt(null),d(!0);return}E(!0),d(!0)}else E(!1),g(null),yt(null),d(!0),A.length===0||setTimeout(()=>{pt()},50)})();else if(typeof window<"u"){if(document.cookie.split(";").some(bt=>bt.trim().startsWith("upsellGiftWheel=")))return;const St=setTimeout(async()=>{nt();const bt=localStorage.getItem("upsellGiftWheelPrize");if(bt&&!q()||(p||xt)&&!q()){if(bt&&!p&&!xt&&!q())try{const Lt=JSON.parse(bt);yt(Lt),g(Lt)}catch{localStorage.removeItem("upsellGiftWheelPrize");return}E(!0),d(!0)}else E(!1),g(null),yt(null),d(!0),A.length===0||setTimeout(()=>{pt()},50)},6e4);return()=>{clearTimeout(St)}}},[o]),G.useEffect(()=>()=>{lt&&cancelAnimationFrame(lt)},[lt]),G.useEffect(()=>{if(typeof window<"u")if(document.cookie.split(";").some(bt=>bt.trim().startsWith("upsellGiftWheel=")))st(!1);else{const bt=setTimeout(()=>{st(!1)},1e4);return()=>clearTimeout(bt)}},[]),f.jsxs(f.Fragment,{children:[u&&!c&&f.jsxs(fv,{mainColor:a,onClick:V,className:P?"pulse":"","aria-label":"Hediye Çarkını Aç",children:[f.jsx(dv,{children:"HEDİYE ÇARKI"}),f.jsx("div",{className:"gift-icon",children:f.jsxs("svg",{width:"24",height:"24",viewBox:"0 0 24 24",fill:"none",xmlns:"http://www.w3.org/2000/svg",children:[f.jsx("circle",{cx:"12",cy:"12",r:"10",stroke:"currentColor",strokeWidth:"1.5",fill:"none"}),f.jsx("path",{d:"M12 2 L12 22 M2 12 L22 12",stroke:"currentColor",strokeWidth:"1",opacity:"0.7"}),f.jsx("path",{d:"M5.64 5.64 L18.36 18.36 M18.36 5.64 L5.64 18.36",stroke:"currentColor",strokeWidth:"1",opacity:"0.7"}),f.jsx("circle",{cx:"12",cy:"12",r:"3",fill:"currentColor"}),f.jsx("path",{d:"M12 2 L14 6 L10 6 Z",fill:"currentColor"})]})})]}),f.jsx(rv,{style:{display:c?"block":"none"},children:c&&f.jsxs(sv,{ref:_,mainColor:a,children:[f.jsx(Wy,{onClick:w,children:f.jsx("span",{style:{color:"#000",float:"right",fontSize:"35px"},children:"×"})}),f.jsxs(ov,{children:[f.jsx(zf,{mainColor:a}),f.jsx(Af,{mainColor:a}),f.jsx(Tf,{mainColor:a}),f.jsxs(Iy,{children:[f.jsx("div",{className:"gift-wheel",style:{marginBottom:"16px",position:"relative",display:v?"none":"flex",justifyContent:"center",cursor:L?"not-allowed":"pointer",transition:"all 0.3s ease",transform:L?"scale(1.02)":"scale(1)",minHeight:A.length===0?"320px":"auto",alignItems:"center"},children:A.length===0?f.jsxs("div",{style:{display:"flex",flexDirection:"column",alignItems:"center",justifyContent:"center",gap:"16px",color:"#666",fontSize:"16px"},children:[S?f.jsxs(f.Fragment,{children:[f.jsx("div",{style:{fontSize:"48px"},children:"⚠️"}),f.jsx("span",{style:{color:"#e40000",textAlign:"center"},children:S}),f.jsx("button",{onClick:()=>{x(""),be()},style:{padding:"8px 16px",background:a||"#e7333c",color:"white",border:"none",borderRadius:"6px",cursor:"pointer",fontSize:"14px"},children:"Tekrar Dene"})]}):f.jsxs(f.Fragment,{children:[f.jsx("div",{style:{width:"40px",height:"40px",border:`3px solid ${a||"#e7333c"}20`,borderTop:`3px solid ${a||"#e7333c"}`,borderRadius:"50%",animation:"spin 1s linear infinite"}}),f.jsx("span",{children:"Hediye çarkı yükleniyor..."})]}),f.jsx("style",{children:`
                        @keyframes spin {
