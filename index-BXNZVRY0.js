 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var mh;function Zx(){if(mh)return _e;mh=1;var a=Symbol.for("react.transitional.element"),r=Symbol.for("react.portal"),o=Symbol.for("react.fragment"),u=Symbol.for("react.strict_mode"),c=Symbol.for("react.profiler"),d=Symbol.for("react.consumer"),p=Symbol.for("react.context"),g=Symbol.for("react.forward_ref"),E=Symbol.for("react.suspense"),x=Symbol.for("react.memo"),b=Symbol.for("react.lazy"),_=Symbol.iterator;function v(w){return w===null||typeof w!="object"?null:(w=_&&w[_]||w["@@iterator"],typeof w=="function"?w:null)}var X={isMounted:function(){return!1},enqueueForceUpdate:function(){},enqueueReplaceState:function(){},enqueueSetState:function(){}},j=Object.assign,B={};function R(w,V,ne){this.props=w,this.context=V,this.refs=B,this.updater=ne||X}R.prototype.isReactComponent={},R.prototype.setState=function(w,V){if(typeof w!="object"&&typeof w!="function"&&w!=null)throw Error("takes an object of state variables to update or a function which returns an object of state variables.");this.updater.enqueueSetState(this,w,V,"setState")},R.prototype.forceUpdate=function(w){this.updater.enqueueForceUpdate(this,w,"forceUpdate")};function J(){}J.prototype=R.prototype;function U(w,V,ne){this.props=w,this.context=V,this.refs=B,this.updater=ne||X}var Z=U.prototype=new J;Z.constructor=U,j(Z,R.prototype),Z.isPureReactComponent=!0;var re=Array.isArray,q={H:null,A:null,T:null,S:null,V:null},te=Object.prototype.hasOwnProperty;function Q(w,V,ne,H,W,oe){return ne=oe.ref,{$$typeof:a,type:w,key:V,ref:ne!==void 0?ne:null,props:oe}}function le(w,V){return Q(w.type,V,void 0,void 0,void 0,w.props)}function Ee(w){return typeof w=="object"&&w!==null&&w.$$typeof===a}function Ge(w){var V={"=":"=0",":":"=2"};return"$"+w.replace(/[=:]/g,function(ne){return V[ne]})}var Re=/\/+/g;function P(w,V){return typeof w=="object"&&w!==null&&w.key!=null?Ge(""+w.key):V.toString(36)}function se(){}function ye(w){switch(w.status){case"fulfilled":return w.value;case"rejected":throw w.reason;default:switch(typeof w.status=="string"?w.then(se,se):(w.status="pending",w.then(function(V){w.status==="pending"&&(w.status="fulfilled",w.value=V)},function(V){w.status==="pending"&&(w.status="rejected",w.reason=V)})),w.status){case"fulfilled":return w.value;case"rejected":throw w.reason}}throw w}function ve(w,V,ne,H,W){var oe=typeof w;(oe==="undefined"||oe==="boolean")&&(w=null);var ue=!1;if(w===null)ue=!0;else switch(oe){case"bigint":case"string":case"number":ue=!0;break;case"object":switch(w.$$typeof){case a:case r:ue=!0;break;case b:return ue=w._init,ve(ue(w._payload),V,ne,H,W)}}if(ue)return W=W(w),ue=H===""?"."+P(w,0):H,re(W)?(ne="",ue!=null&&(ne=ue.replace(Re,"$&/")+"/"),ve(W,V,ne,"",function(Ce){return Ce})):W!=null&&(Ee(W)&&(W=le(W,ne+(W.key==null||w&&w.key===W.key?"":(""+W.key).replace(Re,"$&/")+"/")+ue)),V.push(W)),1;ue=0;var xe=H===""?".":H+":";if(re(w))for(var me=0;me<w.length;me++)H=w[me],oe=xe+P(H,me),ue+=ve(H,V,ne,oe,W);else if(me=v(w),typeof me=="function")for(w=me.call(w),me=0;!(H=w.next()).done;)H=H.value,oe=xe+P(H,me++),ue+=ve(H,V,ne,oe,W);else if(oe==="object"){if(typeof w.then=="function")return ve(ye(w),V,ne,H,W);throw V=String(w),Error("Objects are not valid as a React child (found: "+(V==="[object Object]"?"object with keys {"+Object.keys(w).join(", ")+"}":V)+"). If you meant to render a collection of children, use an array instead.")}return ue}function O(w,V,ne){if(w==null)return w;var H=[],W=0;return ve(w,H,"","",function(oe){return V.call(ne,oe,W++)}),H}function F(w){if(w._status===-1){var V=w._result;V=V(),V.then(function(ne){(w._status===0||w._status===-1)&&(w._status=1,w._result=ne)},function(ne){(w._status===0||w._status===-1)&&(w._status=2,w._result=ne)}),w._status===-1&&(w._status=0,w._result=V)}if(w._status===1)return w._result.default;throw w._result}var fe=typeof reportError=="function"?reportError:function(w){if(typeof window=="object"&&typeof window.ErrorEvent=="function"){var V=new window.ErrorEvent("error",{bubbles:!0,cancelable:!0,message:typeof w=="object"&&w!==null&&typeof w.message=="string"?String(w.message):String(w),error:w});if(!window.dispatchEvent(V))return}else if(typeof process=="object"&&typeof process.emit=="function"){process.emit("uncaughtException",w);return}console.error(w)};function Se(){}return _e.Children={map:O,forEach:function(w,V,ne){O(w,function(){V.apply(this,arguments)},ne)},count:function(w){var V=0;return O(w,function(){V++}),V},toArray:function(w){return O(w,function(V){return V})||[]},only:function(w){if(!Ee(w))throw Error("React.Children.only expected to receive a single React element child.");return w}},_e.Component=R,_e.Fragment=o,_e.Profiler=c,_e.PureComponent=U,_e.StrictMode=u,_e.Suspense=E,_e.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE=q,_e.__COMPILER_RUNTIME={__proto__:null,c:function(w){return q.H.useMemoCache(w)}},_e.cache=function(w){return function(){return w.apply(null,arguments)}},_e.cloneElement=function(w,V,ne){if(w==null)throw Error("The argument must be a React element, but you passed "+w+".");var H=j({},w.props),W=w.key,oe=void 0;if(V!=null)for(ue in V.ref!==void 0&&(oe=void 0),V.key!==void 0&&(W=""+V.key),V)!te.call(V,ue)||ue==="key"||ue==="__self"||ue==="__source"||ue==="ref"&&V.ref===void 0||(H[ue]=V[ue]);var ue=arguments.length-2;if(ue===1)H.children=ne;else if(1<ue){for(var xe=Array(ue),me=0;me<ue;me++)xe[me]=arguments[me+2];H.children=xe}return Q(w.type,W,void 0,void 0,oe,H)},_e.createContext=function(w){return w={$$typeof:p,_currentValue:w,_currentValue2:w,_threadCount:0,Provider:null,Consumer:null},w.Provider=w,w.Consumer={$$typeof:d,_context:w},w},_e.createElement=function(w,V,ne){var H,W={},oe=null;if(V!=null)for(H in V.key!==void 0&&(oe=""+V.key),V)te.call(V,H)&&H!=="key"&&H!=="__self"&&H!=="__source"&&(W[H]=V[H]);var ue=arguments.length-2;if(ue===1)W.children=ne;else if(1<ue){for(var xe=Array(ue),me=0;me<ue;me++)xe[me]=arguments[me+2];W.children=xe}if(w&&w.defaultProps)for(H in ue=w.defaultProps,ue)W[H]===void 0&&(W[H]=ue[H]);return Q(w,oe,void 0,void 0,null,W)},_e.createRef=function(){return{current:null}},_e.forwardRef=function(w){return{$$typeof:g,render:w}},_e.isValidElement=Ee,_e.lazy=function(w){return{$$typeof:b,_payload:{_status:-1,_result:w},_init:F}},_e.memo=function(w,V){return{$$typeof:x,type:w,compare:V===void 0?null:V}},_e.startTransition=function(w){var V=q.T,ne={};q.T=ne;try{var H=w(),W=q.S;W!==null&&W(ne,H),typeof H=="object"&&H!==null&&typeof H.then=="function"&&H.then(Se,fe)}catch(oe){fe(oe)}finally{q.T=V}},_e.unstable_useCacheRefresh=function(){return q.H.useCacheRefresh()},_e.use=function(w){return q.H.use(w)},_e.useActionState=function(w,V,ne){return q.H.useActionState(w,V,ne)},_e.useCallback=function(w,V){return q.H.useCallback(w,V)},_e.useContext=function(w){return q.H.useContext(w)},_e.useDebugValue=function(){},_e.useDeferredValue=function(w,V){return q.H.useDeferredValue(w,V)},_e.useEffect=function(w,V,ne){var H=q.H;if(typeof ne=="function")throw Error("useEffect CRUD overload is not enabled in this build of React.");return H.useEffect(w,V)},_e.useId=function(){return q.H.useId()},_e.useImperativeHandle=function(w,V,ne){return q.H.useImperativeHandle(w,V,ne)},_e.useInsertionEffect=function(w,V){return q.H.useInsertionEffect(w,V)},_e.useLayoutEffect=function(w,V){return q.H.useLayoutEffect(w,V)},_e.useMemo=function(w,V){return q.H.useMemo(w,V)},_e.useOptimistic=function(w,V){return q.H.useOptimistic(w,V)},_e.useReducer=function(w,V,ne){return q.H.useReducer(w,V,ne)},_e.useRef=function(w){return q.H.useRef(w)},_e.useState=function(w){return q.H.useState(w)},_e.useSyncExternalStore=function(w,V,ne){return q.H.useSyncExternalStore(w,V,ne)},_e.useTransition=function(){return q.H.useTransition()},_e.version="19.1.1",_e}var gh;function sf(){return gh||(gh=1,kc.exports=Zx()),kc.exports}var Rc={exports:{}},Ut={};/**
 * @license React
...
`,Ny=({mainColor:a,stockReminderUsageChannel:r,forceOpen:o})=>{const u=Y.useRef(null),[c,d]=Y.useState(o||!1),[p,g]=Y.useState(!1),[E,x]=Y.useState(""),[b,_]=Y.useState(!1),[v,X]=Y.useState(),[j,B]=Y.useState(),[R,J]=Y.useState(!1),[U,Z]=Y.useState(!1),[re,q]=Y.useState(null),te=Y.useRef(null),Q=Y.useRef(null),le=Y.useRef(null),Ee=()=>{document.querySelectorAll(".nostok").forEach(W=>{if(!W.querySelector(".stock_bell_icon")){const oe=document.createElementNS("http://www.w3.org/2000/svg","svg");oe.setAttribute("class","stock_bell_icon"),oe.setAttribute("height","18"),oe.setAttribute("width","18"),oe.setAttribute("viewBox","0 0 512 512"),oe.style.pointerEvents="none";const ue=document.createElementNS("http://www.w3.org/2000/svg","g");["m437.017 39.687c-5.858-5.857-15.356-5.857-21.213 0-5.858 5.858-5.857 15.356 0 21.213 42.688 42.685 66.196 99.438 66.196 159.807 0 8.284 6.716 15 15 15s15-6.716 15-15c0-68.382-26.629-132.67-74.983-181.02z","m96.193 39.688c-5.858-5.857-15.355-5.858-21.213 0-48.352 48.354-74.98 112.641-74.98 181.019 0 8.284 6.716 15 15 15s15-6.716 15-15c0-60.365 23.508-117.118 66.193-159.805 5.858-5.858 5.858-15.356 0-21.214z","m370.358 85.125c-5.858 5.858-5.857 15.355 0 21.213 30.55 30.548 47.374 71.164 47.374 114.368 0 8.284 6.716 15 15 15s15-6.716 15-15c0-51.217-19.945-99.368-56.161-135.582-5.858-5.856-15.355-5.856-21.213.001z","m141.634 85.132c-5.858-5.857-15.356-5.857-21.213.001-36.211 36.216-56.154 84.363-56.154 135.573 0 8.284 6.716 15 15 15s15-6.716 15-15c0-43.197 16.823-83.811 47.369-114.361 5.857-5.858 5.856-15.355-.002-21.213z","m383.467 329.632v-76.792c0-28.011-8.918-54.59-25.79-76.865-14.101-18.617-33.332-33.16-54.939-41.717-3.007-23.111-22.82-41.018-46.738-41.018s-43.733 17.906-46.74 41.018c-21.606 8.558-40.837 23.101-54.938 41.717-16.872 22.275-25.79 48.854-25.79 76.865v76.792l-30.549 61.1c-2.325 4.65-2.076 10.172.657 14.594s7.561 7.114 12.76 7.114h66.774c7.033 36.558 39.246 64.267 77.825 64.267 38.578 0 70.791-27.709 77.823-64.267h66.778c5.199 0 10.027-2.692 12.76-7.114s2.981-9.944.657-14.594zm-127.467 117.075c-21.938 0-40.573-14.413-46.933-34.267h93.865c-6.36 19.854-24.994 34.267-46.932 34.267zm64.266-64.267h-128.533-56.062l21.279-42.559c1.042-2.083 1.583-4.379 1.583-6.708v-80.333c0-42.793 28.625-81.203 69.612-93.405 6.36-1.894 10.72-7.741 10.72-14.376v-4.686c0-9.447 7.687-17.133 17.135-17.133 9.447 0 17.133 7.686 17.133 17.133v4.686c0 6.636 4.36 12.483 10.72 14.376 40.987 12.202 69.614 50.611 69.614 93.405v80.333c0 2.329.542 4.625 1.583 6.708l21.279 42.559z"].forEach(me=>{const Ce=document.createElementNS("http://www.w3.org/2000/svg","path");Ce.setAttribute("d",me),ue.appendChild(Ce)}),oe.appendChild(ue),W.appendChild(oe)}})},Ge=()=>{le.current&&clearInterval(le.current),le.current=setInterval(()=>{document.querySelectorAll(".stock_bell_icon").forEach(W=>{const oe=W;oe.classList.add("bell-animate"),setTimeout(()=>{oe.classList.remove("bell-animate")},1e3)})},3e3)},Re=()=>{const H=document.getElementById("dynamicNostokBellStyles");H&&H.remove();const W=document.createElement("style");W.id="dynamicNostokBellStyles",W.innerHTML=`
    ...
    `,document.head.appendChild(W)};Y.useEffect(()=>{typeof window<"u"&&(window.currentProduct?X(window.currentProduct):window.productDetailModel&&X(window.productDetailModel))},[]),Y.useEffect(()=>(Re(),()=>{const H=document.getElementById("dynamicNostokBellStyles");H&&H.remove()}),[a]),Y.useEffect(()=>{typeof window<"u"&&v&&(Ee(),Ge())},[v]),Y.useEffect(()=>()=>{le.current&&clearInterval(le.current)},[]);const{register:P,handleSubmit:se,formState:{errors:ye},reset:ve,clearErrors:O}=vr(),F=()=>{d(!1),B(null),Z(!1),q(null),ve(),O(),x(""),J(!1)};u!==null&&nl(u,F);const fe=se(H=>{g(!0),v&&(v.productVariantData&&!j||qe.post("https://api.upsell.co/phonesubscription/reminder",{...r===1||r===2?{phone:"90"+H.phone,email:""}:{email:H.email,phone:""},productName:v.productName,productSlug:window.location.pathname,productId:`${v.productVariantData?j?.variantOptions[0].urunID:v.product.id}`,productCardId:v.product.urunKartiId.toString(),variant:(JSON.stringify(j)??"{}")||"{}",hasVariant:v.productVariantData!==null}).then(()=>{_(!0),d(!1)}).catch(()=>{x(r===1||r===2?"Bu telefon numarası zaten kayıtlı.":"Bu e-posta adresi zaten kayıtlı.")}).finally(()=>{g(!1)}))});Y.useEffect(()=>{if(o)d(!0);else if(typeof window<"u"){const H=xe=>{xe.preventDefault(),xe.stopPropagation();const me=xe.currentTarget;let Ce=me.getAttribute("data-variant-definition");if(!Ce){const at=me.querySelector("[data-variant-definition]");at&&(Ce=at.getAttribute("data-variant-definition"))}q(Ce),c||d(!0)},W=()=>{c||d(!0)};te.current=H,Q.current=W;const oe=document.getElementById("upsell-ss-reminder");oe&&(oe.removeEventListener("click",Q.current),oe.addEventListener("click",W));const ue=document.querySelectorAll(".nostok");if(ue.forEach(xe=>{te.current&&xe.removeEventListener("click",te.current)}),ue.forEach(xe=>{xe.addEventListener("click",H)}),v){const xe=v.productVariantData?.some(at=>at.stokAdedi===0),me=v.productVariantData===null&&v.totalStockAmount===0;if(xe||me){const at=v.productVariantData!==null&&v.totalStockAmount===0;if(ue.length===0||at)if(oe)oe.style.display="flex";else{const bt=()=>{if(typeof window.$<"u"){const pe=document.querySelector(".MiddleList");if(pe&&!document.getElementById("upsell-ss-reminder")){const be=`
