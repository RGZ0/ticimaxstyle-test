 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var mh;function Xx(){if(mh)return De;mh=1;var i=Symbol.for("react.transitional.element"),r=Symbol.for("react.portal"),o=Symbol.for("react.fragment"),s=Symbol.for("react.strict_mode"),c=Symbol.for("react.profiler"),d=Symbol.for("react.consumer"),p=Symbol.for("react.context"),g=Symbol.for("react.forward_ref"),w=Symbol.for("react.suspense"),x=Symbol.for("react.memo"),v=Symbol.for("react.lazy"),O=Symbol.iterator;function E(y){return y===null||typeof y!="object"?null:(y=O&&y[O]||y["@@iterator"],typeof y=="function"?y:null)}var Q={isMounted:function(){return!1},enqueueForceUpdate:function(){},enqueueReplaceState:function(){},enqueueSetState:function(){}},C=Object.assign,q={};function N(y,M,ie){this.props=y,this.context=M,this.refs=q,this.updater=ie||Q}N.prototype.isReactComponent={},N.prototype.setState=function(y,M){if(typeof y!="object"&&typeof y!="function"&&y!=null)throw Error("takes an object of state variables to update or a function which returns an object of state variables.");this.updater.enqueueSetState(this,y,M,"setState")},N.prototype.forceUpdate=function(y){this.updater.enqueueForceUpdate(this,y,"forceUpdate")};function I(){}I.prototype=N.prototype;function Y(y,M,ie){this.props=y,this.context=M,this.refs=q,this.updater=ie||Q}var Z=Y.prototype=new I;Z.constructor=Y,C(Z,N.prototype),Z.isPureReactComponent=!0;var le=Array.isArray,L={H:null,A:null,T:null,S:null,V:null},P=Object.prototype.hasOwnProperty;function K(y,M,ie,ae,de,Ae){return ie=Ae.ref,{$$typeof:i,type:y,key:M,ref:ie!==void 0?ie:null,props:Ae}}function ee(y,M){return K(y.type,M,void 0,void 0,void 0,y.props)}function me(y){return typeof y=="object"&&y!==null&&y.$$typeof===i}function Ce(y){var M={"=":"=0",":":"=2"};return"$"+y.replace(/[=:]/g,function(ie){return M[ie]})}var ze=/\/+/g;function se(y,M){return typeof y=="object"&&y!==null&&y.key!=null?Ce(""+y.key):M.toString(36)}function he(){}function be(y){switch(y.status){case"fulfilled":return y.value;case"rejected":throw y.reason;default:switch(typeof y.status=="string"?y.then(he,he):(y.status="pending",y.then(function(M){y.status==="pending"&&(y.status="fulfilled",y.value=M)},function(M){y.status==="pending"&&(y.status="rejected",y.reason=M)})),y.status){case"fulfilled":return y.value;case"rejected":throw y.reason}}throw y}function ge(y,M,ie,ae,de){var Ae=typeof y;(Ae==="undefined"||Ae==="boolean")&&(y=null);var ce=!1;if(y===null)ce=!0;else switch(Ae){case"bigint":case"string":case"number":ce=!0;break;case"object":switch(y.$$typeof){case i:case r:ce=!0;break;case v:return ce=y._init,ge(ce(y._payload),M,ie,ae,de)}}if(ce)return de=de(y),ce=ae===""?"."+se(y,0):ae,le(de)?(ie="",ce!=null&&(ie=ce.replace(ze,"$&/")+"/"),ge(de,M,ie,"",function(Xe){return Xe})):de!=null&&(me(de)&&(de=ee(de,ie+(de.key==null||y&&y.key===de.key?"":(""+de.key).replace(ze,"$&/")+"/")+ce)),M.push(de)),1;ce=0;var Te=ae===""?".":ae+":";if(le(y))for(var we=0;we<y.length;we++)ae=y[we],Ae=Te+se(ae,we),ce+=ge(ae,M,ie,Ae,de);else if(we=E(y),typeof we=="function")for(y=we.call(y),we=0;!(ae=y.next()).done;)ae=ae.value,Ae=Te+se(ae,we++),ce+=ge(ae,M,ie,Ae,de);else if(Ae==="object"){if(typeof y.then=="function")return ge(be(y),M,ie,ae,de);throw M=String(y),Error("Objects are not valid as a React child (found: "+(M==="[object Object]"?"object with keys {"+Object.keys(y).join(", ")+"}":M)+"). If you meant to render a collection of children, use an array instead.")}return ce}function j(y,M,ie){if(y==null)return y;var ae=[],de=0;return ge(y,ae,"","",function(Ae){return M.call(ie,Ae,de++)}),ae}function U(y){if(y._status===-1){var M=y._result;M=M(),M.then(function(ie){(y._status===0||y._status===-1)&&(y._status=1,y._result=ie)},function(ie){(y._status===0||y._status===-1)&&(y._status=2,y._result=ie)}),y._status===-1&&(y._status=0,y._result=M)}if(y._status===1)return y._result.default;throw y._result}var te=typeof reportError=="function"?reportError:function(y){if(typeof window=="object"&&typeof window.ErrorEvent=="function"){var M=new window.ErrorEvent("error",{bubbles:!0,cancelable:!0,message:typeof y=="object"&&y!==null&&typeof y.message=="string"?String(y.message):String(y),error:y});if(!window.dispatchEvent(M))return}else if(typeof process=="object"&&typeof process.emit=="function"){process.emit("uncaughtException",y);return}console.error(y)};function F(){}return De.Children={map:j,forEach:function(y,M,ie){j(y,function(){M.apply(this,arguments)},ie)},count:function(y){var M=0;return j(y,function(){M++}),M},toArray:function(y){return j(y,function(M){return M})||[]},only:function(y){if(!me(y))throw Error("React.Children.only expected to receive a single React element child.");return y}},De.Component=N,De.Fragment=o,De.Profiler=c,De.PureComponent=Y,De.StrictMode=s,De.Suspense=w,De.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE=L,De.__COMPILER_RUNTIME={__proto__:null,c:function(y){return L.H.useMemoCache(y)}},De.cache=function(y){return function(){return y.apply(null,arguments)}},De.cloneElement=function(y,M,ie){if(y==null)throw Error("The argument must be a React element, but you passed "+y+".");var ae=C({},y.props),de=y.key,Ae=void 0;if(M!=null)for(ce in M.ref!==void 0&&(Ae=void 0),M.key!==void 0&&(de=""+M.key),M)!P.call(M,ce)||ce==="key"||ce==="__self"||ce==="__source"||ce==="ref"&&M.ref===void 0||(ae[ce]=M[ce]);var ce=arguments.length-2;if(ce===1)ae.children=ie;else if(1<ce){for(var Te=Array(ce),we=0;we<ce;we++)Te[we]=arguments[we+2];ae.children=Te}return K(y.type,de,void 0,void 0,Ae,ae)},De.createContext=function(y){return y={$$typeof:p,_currentValue:y,_currentValue2:y,_threadCount:0,Provider:null,Consumer:null},y.Provider=y,y.Consumer={$$typeof:d,_context:y},y},De.createElement=function(y,M,ie){var ae,de={},Ae=null;if(M!=null)for(ae in M.key!==void 0&&(Ae=""+M.key),M)P.call(M,ae)&&ae!=="key"&&ae!=="__self"&&ae!=="__source"&&(de[ae]=M[ae]);var ce=arguments.length-2;if(ce===1)de.children=ie;else if(1<ce){for(var Te=Array(ce),we=0;we<ce;we++)Te[we]=arguments[we+2];de.children=Te}if(y&&y.defaultProps)for(ae in ce=y.defaultProps,ce)de[ae]===void 0&&(de[ae]=ce[ae]);return K(y,Ae,void 0,void 0,null,de)},De.createRef=function(){return{current:null}},De.forwardRef=function(y){return{$$typeof:g,render:y}},De.isValidElement=me,De.lazy=function(y){return{$$typeof:v,_payload:{_status:-1,_result:y},_init:U}},De.memo=function(y,M){return{$$typeof:x,type:y,compare:M===void 0?null:M}},De.startTransition=function(y){var M=L.T,ie={};L.T=ie;try{var ae=y(),de=L.S;de!==null&&de(ie,ae),typeof ae=="object"&&ae!==null&&typeof ae.then=="function"&&ae.then(F,te)}catch(Ae){te(Ae)}finally{L.T=M}},De.unstable_useCacheRefresh=function(){return L.H.useCacheRefresh()},De.use=function(y){return L.H.use(y)},De.useActionState=function(y,M,ie){return L.H.useActionState(y,M,ie)},De.useCallback=function(y,M){return L.H.useCallback(y,M)},De.useContext=function(y){return L.H.useContext(y)},De.useDebugValue=function(){},De.useDeferredValue=function(y,M){return L.H.useDeferredValue(y,M)},De.useEffect=function(y,M,ie){var ae=L.H;if(typeof ie=="function")throw Error("useEffect CRUD overload is not enabled in this build of React.");return ae.useEffect(y,M)},De.useId=function(){return L.H.useId()},De.useImperativeHandle=function(y,M,ie){return L.H.useImperativeHandle(y,M,ie)},De.useInsertionEffect=function(y,M){return L.H.useInsertionEffect(y,M)},De.useLayoutEffect=function(y,M){return L.H.useLayoutEffect(y,M)},De.useMemo=function(y,M){return L.H.useMemo(y,M)},De.useOptimistic=function(y,M){return L.H.useOptimistic(y,M)},De.useReducer=function(y,M,ie){return L.H.useReducer(y,M,ie)},De.useRef=function(y){return L.H.useRef(y)},De.useState=function(y){return L.H.useState(y)},De.useSyncExternalStore=function(y,M,ie){return L.H.useSyncExternalStore(y,M,ie)},De.useTransition=function(){return L.H.useTransition()},De.version="19.1.1",De}var gh;function of(){return gh||(gh=1,Dc.exports=Xx()),Dc.exports}var X=of();const ft=Vx(X);var Oc={exports:{}},Fl={},kc={exports:{}},_c={};/**
 * @license React
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var xh;function Zx(){return xh||(xh=1,(function(i){function r(j,U){var te=j.length;j.push(U);e:for(;0<te;){var F=te-1>>>1,y=j[F];if(0<c(y,U))j[F]=U,j[te]=y,te=F;else break e}}function o(j){return j.length===0?null:j[0]}function s(j){if(j.length===0)return null;var U=j[0],te=j.pop();if(te!==U){j[0]=te;e:for(var F=0,y=j.length,M=y>>>1;F<M;){var ie=2*(F+1)-1,ae=j[ie],de=ie+1,Ae=j[de];if(0>c(ae,te))de<y&&0>c(Ae,ae)?(j[F]=Ae,j[de]=te,F=de):(j[F]=ae,j[ie]=te,F=ie);else if(de<y&&0>c(Ae,te))j[F]=Ae,j[de]=te,F=de;else break e}}return U}function c(j,U){var te=j.sortIndex-U.sortIndex;return te!==0?te:j.id-U.id}if(i.unstable_now=void 0,typeof performance=="object"&&typeof performance.now=="function"){var d=performance;i.unstable_now=function(){return d.now()}}else{var p=Date,g=p.now();i.unstable_now=function(){return p.now()-g}}var w=[],x=[],v=1,O=null,E=3,Q=!1,C=!1,q=!1,N=!1,I=typeof setTimeout=="function"?setTimeout:null,Y=typeof clearTimeout=="function"?clearTimeout:null,Z=typeof setImmediate<"u"?setImmediate:null;function le(j){for(var U=o(x);U!==null;){if(U.callback===null)s(x);else if(U.startTime<=j)s(x),U.sortIndex=U.expirationTime,r(w,U);else break;U=o(x)}}function L(j){if(q=!1,le(j),!C)if(o(w)!==null)C=!0,P||(P=!0,se());else{var U=o(x);U!==null&&ge(L,U.startTime-j)}}var P=!1,K=-1,ee=5,me=-1;function Ce(){return N?!0:!(i.unstable_now()-me<ee)}function ze(){if(N=!1,P){var j=i.unstable_now();me=j;var U=!0;try{e:{C=!1,q&&(q=!1,Y(K),K=-1),Q=!0;var te=E;try{t:{for(le(j),O=o(w);O!==null&&!(O.expirationTime>j&&Ce());){var F=O.callback;if(typeof F=="function"){O.callback=null,E=O.priorityLevel;var y=F(O.expirationTime<=j);if(j=i.unstable_now(),typeof y=="function"){O.callback=y,le(j),U=!0;break t}O===o(w)&&s(w),le(j)}else s(w);O=o(w)}if(O!==null)U=!0;else{var M=o(x);M!==null&&ge(L,M.startTime-j),U=!1}}break e}finally{O=null,E=te,Q=!1}U=void 0}}finally{U?se():P=!1}}}var se;if(typeof Z=="function")se=function(){Z(ze)};else if(typeof MessageChannel<"u"){var he=new MessageChannel,be=he.port2;he.port1.onmessage=ze,se=function(){be.postMessage(null)}}else se=function(){I(ze,0)};function ge(j,U){K=I(function(){j(i.unstable_now())},U)}i.unstable_IdlePriority=5,i.unstable_ImmediatePriority=1,i.unstable_LowPriority=4,i.unstable_NormalPriority=3,i.unstable_Profiling=null,i.unstable_UserBlockingPriority=2,i.unstable_cancelCallback=function(j){j.callback=null},i.unstable_forceFrameRate=function(j){0>j||125<j?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):ee=0<j?Math.floor(1e3/j):5},i.unstable_getCurrentPriorityLevel=function(){return E},i.unstable_next=function(j){switch(E){case 1:case 2:case 3:var U=3;break;default:U=E}var te=E;E=U;try{return j()}finally{E=te}},i.unstable_requestPaint=function(){N=!0},i.unstable_runWithPriority=function(j,U){switch(j){case 1:case 2:case 3:case 4:case 5:break;default:j=3}var te=E;E=j;try{return U()}finally{E=te}},i.unstable_scheduleCallback=function(j,U,te){var F=i.unstable_now();switch(typeof te=="object"&&te!==null?(te=te.delay,te=typeof te=="number"&&0<te?F+te:F):te=F,j){case 1:var y=-1;break;case 2:y=250;break;case 5:y=1073741823;break;case 4:y=1e4;break;default:y=5e3}return y=te+y,j={id:v++,callback:U,priorityLevel:j,startTime:te,expirationTime:y,sortIndex:-1},te>F?(j.sortIndex=te,r(x,j),o(w)===null&&j===o(x)&&(q?(Y(K),K=-1):q=!0,ge(L,te-F))):(j.sortIndex=y,r(w,j),C||Q||(C=!0,P||(P=!0,se()))),j},i.unstable_shouldYield=Ce,i.unstable_wrapCallback=function(j){var U=E;return function(){var te=E;E=U;try{return j.apply(this,arguments)}finally{E=te}}}})(_c)),_c}var yh;function $x(){return yh||(yh=1,kc.exports=Zx()),kc.exports}var Rc={exports:{}},Rt={};/**
 * @license React
...
`,vv=({mainColor:i,logo:r,forceOpen:o,showFloatingButton:s=!0})=>{var gt,ti,Un,Oi;const[c,d]=X.useState(o||!1),[p,g]=X.useState(null),[w,x]=X.useState(""),[v,O]=X.useState(!1),[E,Q]=X.useState([]),[C,q]=X.useState(0),[N,I]=X.useState(null),[Y,Z]=X.useState(!1),[le,L]=X.useState(0),[P,K]=X.useState(!1),[ee,me]=X.useState(null),[Ce,ze]=X.useState(!1),[se,he]=X.useState(!0),[be,ge]=X.useState(null),[j,U]=X.useState(!0),te=X.useRef(null),{register:F,handleSubmit:y,formState:{errors:M}}=dr(),ie=()=>{d(!1);const Ue=new Date;Ue.setDate(Ue.getDate()+Number(le));const Ee="expires="+Ue.toUTCString();document.cookie=`upsellGiftWheel=false;${Ee};path=/`},ae=()=>{he(!1),x("");const Ue=document.cookie.split(";").find(Ve=>Ve.trim().startsWith("upsellGiftWheel="));if(console.log("🎡 GiftWheel Debug:"),console.log("Cookie:",Ue),console.log("Current coupon:",p),console.log("Current userWonPrize:",be),console.log("Current completed:",v),p||be){console.log("🎁 Hediye bulundu, hediye ekranını göster"),O(!0),U(!1),d(!0);return}const Ee=localStorage.getItem("upsellGiftWheelPrize");if(Ee)try{const Ve=JSON.parse(Ee);console.log("💾 localStorage'dan hediye bulundu:",Ve),ge(Ve),g(Ve),O(!0),U(!1),d(!0);return}catch(Ve){console.log("❌ localStorage parse hatası:",Ve),localStorage.removeItem("upsellGiftWheelPrize")}Ue&&Ue.includes("true")&&console.log("🍪 Cookie true ama hediye bulunamadı, çark ekranını göster"),console.log("🎡 Çark çevirme ekranını göster"),O(!1),U(!0),g(null),ge(null),d(!0),E.length===0?Mt():setTimeout(()=>{we()},50)};te!==null&&Ia(te,()=>ie());const Ae=async Ue=>{try{await navigator.clipboard.writeText(Ue),ze(!0),setTimeout(()=>ze(!1),2e3)}catch{}},ce=(Ue,Ee,Ve,Pe)=>{const S=Pe*Math.PI/180;return{x:Ue+Ve*Math.cos(S),y:Ee+Ve*Math.sin(S)}},Te=(Ue,Ee=4e3)=>{if(!N)return;const Ve=Date.now(),Pe=C,S=Ue,z=1800,H=.985,re=10;let ne=z,W=Pe,oe=Ve;const xe=()=>{const He=Date.now(),Ht=(He-oe)/1e3;oe=He,ne*=Math.pow(H,Ht*60);const Nt=ne*Ht;W+=Nt;const jn=Math.min((He-Ve)/Ee,1),Ot=1-Math.pow(1-jn,3),qt=Math.pow(jn,2),yn=W,Vt=Pe+(S-Pe)*Ot,At=yn*(1-qt)+Vt*qt;if(N.style.transform=`rotate(${At}deg)`,ne>500){const ni=Math.min(ne/200,3);N.style.filter=`blur(${ni}px)`}else N.style.filter="none";if(jn<1&&ne>re){const ni=requestAnimationFrame(xe);me(ni)}else N.style.transform=`rotate(${S}deg)`,N.style.filter="none",q(S),me(null),setTimeout(()=>{O(!0)},500)},Oe=requestAnimationFrame(xe);me(Oe)},we=()=>{const Ue=document.querySelector(".sectors"),Ee=document.querySelector(".gift-wheel-texts");if(!Ue||!Ee){setTimeout(()=>{const Ve=document.querySelector(".sectors"),Pe=document.querySelector(".gift-wheel-texts");Ve&&Pe&&Xe(Ve,Pe)},100);return}Xe(Ue,Ee)},Xe=(Ue,Ee)=>{Ue.innerHTML="",Ee.innerHTML="";const Ve=200,Pe=200,S=170,z=50,H=360/E.length;E.forEach((re,ne)=>{const W=ne*H,oe=W+H,xe=W+H/2,Oe=ce(Ve,Pe,S,oe),He=ce(Ve,Pe,S,W),Ht=ce(Ve,Pe,z,oe),Nt=ce(Ve,Pe,z,W),jn=oe-W<=180?0:1,xn=`M${Ht.x},${Ht.y} L${Oe.x},${Oe.y} A${S},${S} 0 ${jn} 0 ${He.x},${He.y} L${Nt.x},${Nt.y} A${z},${z} 0 ${jn} 1 ${Ht.x},${Ht.y} Z`,Ot=document.createElementNS("http://www.w3.org/2000/svg","path");Ot.setAttribute("d",xn);const qt=re.color||(ne%2===0?i||"#e7333c":"#ffffff");Ot.setAttribute("fill",qt),Ot.setAttribute("stroke","#fff"),Ot.setAttribute("stroke-width","10"),Ue.appendChild(Ot);const yn=(S+z)/2,Vt=ce(Ve,Pe,yn,xe),At=document.createElementNS("http://www.w3.org/2000/svg","text");At.setAttribute("x",Vt.x.toString()),At.setAttribute("y",Vt.y.toString()),At.setAttribute("text-anchor","middle"),At.setAttribute("dominant-baseline","middle"),At.setAttribute("font-size","16"),At.setAttribute("font-weight","700");const ni=Pa=>{const Bn=Pa.replace("#",""),xo=parseInt(Bn.substr(0,2),16),yr=parseInt(Bn.substr(2,2),16),vr=parseInt(Bn.substr(4,2),16);return(xo*299+yr*587+vr*114)/1e3>128?"#000":"#fff"},xr=re.color?ni(re.color):ne%2===0?"#fff":"#333";At.setAttribute("fill",xr),At.setAttribute("transform",`rotate(${xe} ${Vt.x} ${Vt.y})`),At.textContent=re.text,Ee.appendChild(At)})},Dt=y(async Ue=>{Y||P||(Z(!0),K(!0),await Le.post("https://api.upsell.co/GiftWheel/Spin",{phoneNumber:Ue.phone}).then(Ee=>{var Ve=Ee.data;if(Ve.success){const Pe=Ve.data.sliceIndex;if(typeof Pe=="number"&&!isNaN(Pe)){const z=360/E.length,ne=((360-(Pe*z+z/2))%360+360)%360,W=C+360*5+ne;N&&(ee&&(cancelAnimationFrame(ee),me(null)),N.style.transformOrigin="200px 200px",N.style.transition="none",N.style.webkitTransition="none",Te(W,4e3)),g(Ee.data.data),ge(Ee.data.data),U(!1),localStorage.setItem("upsellGiftWheelPrize",JSON.stringify(Ee.data.data));const oe=new Date;oe.setDate(oe.getDate()+le);const xe="expires="+oe.toUTCString();document.cookie=`upsellGiftWheel=true;${xe};path=/`}else x("Sunucudan geçersiz veri alındı.")}else x(Ve.message)}).catch(Ee=>{x("Bağlantı hatası oluştu. Lütfen tekrar deneyiniz.")}).finally(()=>{setTimeout(()=>{Z(!1),K(!1)},4500)}))}),Mt=async()=>{try{const Ee=(await Le.post("https://api.upsell.co/GiftWheel/Slices",{})).data;Ee.success?(Q(Ee.data.slices),L(Ee.data.frequency)):x("Hediye çarkı yüklenemedi.")}catch{x("Bağlantı hatası oluştu. Lütfen tekrar deneyiniz.")}};return X.useEffect(()=>{Mt()},[]),X.useEffect(()=>{E.length>0&&c&&setTimeout(()=>{we()},100)},[E,c]),X.useEffect(()=>{if(N&&!Y&&!P){N.style.transition="transform 2s ease-in-out";const Ee=setInterval(()=>{if(!Y&&!P&&N){const Ve=C+Math.sin(Date.now()/3e3)*.5;N.style.transform=`rotate(${Ve}deg)`}},100);return()=>{clearInterval(Ee),N&&(N.style.transition="none",N.style.transform=`rotate(${C}deg)`)}}},[N,Y,P,C]),X.useEffect(()=>{if(o)d(!0),E.length===0||setTimeout(()=>{we()},50);else if(typeof window<"u"){if(document.cookie.split(";").some(Ee=>Ee.trim().startsWith("upsellGiftWheel=")))return;const Ue=setTimeout(()=>{O(!1),U(!0),g(null),ge(null),d(!0),E.length===0||setTimeout(()=>{we()},50)},6e4);return()=>{clearTimeout(Ue)}}},[o]),X.useEffect(()=>()=>{ee&&cancelAnimationFrame(ee)},[ee]),X.useEffect(()=>{if(typeof window<"u")if(document.cookie.split(";").some(Ee=>Ee.trim().startsWith("upsellGiftWheel=")))he(!1);else{const Ee=setTimeout(()=>{he(!1)},1e4);return()=>clearTimeout(Ee)}},[]),f.jsxs(f.Fragment,{children:[s&&!c&&f.jsxs(xv,{mainColor:i,onClick:ae,className:se?"pulse":"","aria-label":"Hediye Çarkını Aç",children:[f.jsx(yv,{children:"HEDİYE ÇARKI"}),f.jsx("div",{className:"gift-icon",children:f.jsxs("svg",{width:"24",height:"24",viewBox:"0 0 24 24",fill:"none",xmlns:"http://www.w3.org/2000/svg",children:[f.jsx("circle",{cx:"12",cy:"12",r:"10",stroke:"currentColor",strokeWidth:"1.5",fill:"none"}),f.jsx("path",{d:"M12 2 L12 22 M2 12 L22 12",stroke:"currentColor",strokeWidth:"1",opacity:"0.7"}),f.jsx("path",{d:"M5.64 5.64 L18.36 18.36 M18.36 5.64 L5.64 18.36",stroke:"currentColor",strokeWidth:"1",opacity:"0.7"}),f.jsx("circle",{cx:"12",cy:"12",r:"3",fill:"currentColor"}),f.jsx("path",{d:"M12 2 L14 6 L10 6 Z",fill:"currentColor"})]})})]}),f.jsx(dv,{style:{display:c?"block":"none"},children:c&&f.jsxs(hv,{ref:te,mainColor:i,children:[f.jsx(nv,{onClick:ie,children:f.jsx("span",{style:{color:"#000",float:"right",fontSize:"35px"},children:"×"})}),f.jsxs(pv,{children:[f.jsx(Tf,{mainColor:i}),f.jsx(jf,{mainColor:i}),f.jsx(zf,{mainColor:i}),f.jsxs(iv,{children:[f.jsx("div",{className:"gift-wheel",style:{marginBottom:"16px",position:"relative",display:v?"none":"flex",justifyContent:"center",cursor:Y?"not-allowed":"pointer",transition:"all 0.3s ease",transform:Y?"scale(1.02)":"scale(1)",minHeight:E.length===0?"320px":"auto",alignItems:"center"},children:E.length===0?f.jsxs("div",{style:{display:"flex",flexDirection:"column",alignItems:"center",justifyContent:"center",gap:"16px",color:"#666",fontSize:"16px"},children:[w?f.jsxs(f.Fragment,{children:[f.jsx("div",{style:{fontSize:"48px"},children:"⚠️"}),f.jsx("span",{style:{color:"#e40000",textAlign:"center"},children:w}),f.jsx("button",{onClick:()=>{x(""),Mt()},style:{padding:"8px 16px",background:i||"#e7333c",color:"white",border:"none",borderRadius:"6px",cursor:"pointer",fontSize:"14px"},children:"Tekrar Dene"})]}):f.jsxs(f.Fragment,{children:[f.jsx("div",{style:{width:"40px",height:"40px",border:`3px solid ${i||"#e7333c"}20`,borderTop:`3px solid ${i||"#e7333c"}`,borderRadius:"50%",animation:"spin 1s linear infinite"}}),f.jsx("span",{children:"Hediye çarkı yükleniyor..."})]}),f.jsx("style",{children:`
                        @keyframes spin {
                          0% { transform: rotate(0deg); }
                          100% { transform: rotate(360deg); }
                        }
                      `})]}):f.jsxs("svg",{xmlns:"http://www.w3.org/2000/svg",viewBox:"0 0 400 400",style:{width:"min(320px, 90vw)",height:"min(320px, 90vw)",maxWidth:"100%",pointerEvents:Y?"none":"auto",filter:"drop-shadow(0 8px 25px rgba(0,0,0,0.15))",transition:"filter 0.3s ease"},children:[f.jsx("circle",{cx:"200",cy:"200",r:"190",fill:"none",stroke:"rgba(0,0,0,0.1)",strokeWidth:"8"}),f.jsxs("g",{className:"wheel",ref:Ue=>I(Ue),id:"wheel",style:{transformOrigin:"200px 200px"},children:[f.jsx("g",{className:"sectors"}),f.jsx("g",{className:"gift-wheel-texts",style:{fill:"#fff",fontSize:"16px",fontWeight:700,textAnchor:"middle"}})]}),f.jsx("circle",{cx:"200",cy:"200",r:"180",fill:"none",stroke:i||"#e7333c",strokeWidth:"6"}),f.jsx("circle",{cx:"200",cy:"200",r:"170",fill:"none",stroke:"#ffffff",strokeWidth:"2"}),f.jsx("circle",{cx:"200",cy:"200",r:"45",fill:"#ffffff",stroke:i||"#e7333c",strokeWidth:"3"}),r&&f.jsx("image",{href:r,x:"170",y:"170",width:"60",height:"60",style:{objectFit:"contain"}}),f.jsx("g",{transform:"translate(200, 200)",children:f.jsx("g",{transform:"rotate(0) translate(185, 0)",children:f.jsx("polygon",{points:"-15,0 0,12 15,0 0,-12",fill:i||"#e7333c",stroke:"#ffffff",strokeWidth:"2",style:{filter:"drop-shadow(0 2px 4px rgba(0,0,0,0.3))"}})})})]})}),v&&f.jsxs(uv,{children:[f.jsx(yp,{mainColor:i,children:"🎊 Tebrikler! Hediye Çarkından Kazandınız! 🎁"}),f.jsxs(cv,{mainColor:i,children:[f.jsxs("strong",{children:[p.validDayCount," gün"]})," geçerli"," ",f.jsxs("strong",{children:[p.discountValue.toFixed(2),p.discountType===1?" TL":"%"]})," ","indirim kuponu kazandınız!"]}),f.jsx(fv,{children:"Kupon kodunuzu kopyalayın ve alışverişinizde kullanın"}),f.jsx(mv,{children:p.couponCode}),f.jsx(gv,{mainColor:i,className:Ce?"copied":"",onClick:()=>Ae(p.couponCode),children:Ce?"Kopyalandı!":"Kodu Kopyala"})]}),!v&&f.jsxs(f.Fragment,{children:[f.jsx(yp,{mainColor:i,children:"Hediye Çarkı"}),f.jsxs("form",{style:{display:"flex",flexDirection:"column",width:"90%",margin:"0 auto"},onSubmit:Ue=>Dt(Ue),children:[f.jsxs("div",{style:{display:"flex",flexDirection:"column",flex:1},children:[f.jsx(av,{mainColor:i,type:"string",...F("phone",{required:"Telefon boş bırakılamaz",pattern:{value:/^[0-9]{10}$/,message:"Telefon numarası 10 haneli olmalıdır"}}),placeholder:"5XXXXXXXXX",maxLength:10}),M.phone&&f.jsx(Xc,{children:((ti=(gt=M==null?void 0:M.phone)==null?void 0:gt.message)==null?void 0:ti.toString())??null})]}),f.jsxs(lv,{children:[f.jsx(rv,{mainColor:i,...F("kvkk",{required:"Lütfen bilgilerinizi paylaşmak için onay veriniz"}),type:"checkbox"}),f.jsxs("p",{style:{fontSize:"13px",lineHeight:"1.4",margin:0,color:"#666"},children:[f.jsx("a",{style:{color:i||"#e7333c",textDecoration:"underline",fontWeight:"500"},id:"kvkkLink",href:"/UyelikSozlesme.aspx?sozlemeTipi=5",target:"_blank",children:"Kampanya, duyuru ve bilgilendirmelerden E-Posta, WhatsApp ve SMS yoluyla haberdar olmak istediğimi belirtiyorum. Aydınlatma metni"})," ","için tıklayın."]})]}),M.kvkk&&f.jsx(Xc,{children:((Oi=(Un=M==null?void 0:M.kvkk)==null?void 0:Un.message)==null?void 0:Oi.toString())??null}),w&&f.jsx(Xc,{children:w}),f.jsx("div",{style:{marginTop:"4px"},children:f.jsx(sv,{mainColor:i,disabled:Y||P,style:{opacity:Y||P?.6:1,cursor:Y||P?"not-allowed":"pointer"},children:Y?"Çark Dönüyor...":"Çarkı Çevir"})})]})]})]})]}),f.jsxs(ov,{target:"_blank",href:"https://upsell.co/",children:[f.jsxs("svg",{style:{height:"20px"},id:"Layer_1","data-name":"Layer 1",xmlns:"http://www.w3.org/2000/svg",viewBox:"0 0 368.41 140.39",children:[f.jsx("path",{className:"cls-1",style:{fill:"#e7333c",strokeWidth:"0px"},d:"m59.4,71.7c0,7.8-1.98,13.78-5.92,17.92-3.95,4.15-9.28,6.22-15.97,6.22-6,0-10.63-1.77-13.87-5.32-3.25-3.55-4.87-8.93-4.87-16.13V31.2H0v45.75c0,11.7,3.07,20.53,9.22,26.47,6.15,5.95,14.57,8.93,25.27,8.93,5.2,0,10.05-.97,14.55-2.92,4.5-1.95,8.25-4.73,11.25-8.32v10.2h17.85V31.2h-18.75v40.5Z"}),f.jsx("rect",{className:"cls-1",style:{fill:"#e7333c",strokeWidth:"0px"},x:"320.84",width:"18.75",height:"111.3"}),f.jsx("rect",{className:"cls-1",style:{fill:"#e7333c",strokeWidth:"0px"},x:"349.65",width:"18.75",height:"111.3"}),f.jsxs("g",{children:[f.jsx("path",{className:"cls-1",style:{fill:"#e7333c",strokeWidth:"0px"},d:"m179.44,110.73c-6.35-1.74-11.42-3.94-15.21-6.61l7.37-14.59c3.69,2.46,8.12,4.43,13.29,5.91,5.17,1.49,10.27,2.23,15.29,2.23,11.47,0,17.21-3.02,17.21-9.07,0-2.86-1.46-4.86-4.38-5.99-2.92-1.13-7.6-2.2-14.06-3.23-6.76-1.02-12.27-2.2-16.52-3.53-4.25-1.33-7.94-3.66-11.06-6.99-3.12-3.33-4.69-7.96-4.69-13.9,0-7.78,3.25-14,9.76-18.67,4.05-2.9,8.99-4.9,14.82-6h-60.03c-5.5,0-10.53.95-15.08,2.85-4.55,1.9-8.38,4.75-11.47,8.55v-10.5h-17.85v109.2h18.75v-38.85c6.3,7.2,14.85,10.8,25.65,10.8h55.59c-2.48-.41-4.94-.95-7.38-1.62Zm-33.28-21.33c-4.45,4.6-10.12,6.9-17.02,6.9-4.5,0-8.55-1.02-12.15-3.07-3.6-2.05-6.45-4.97-8.55-8.78-2.1-3.8-3.15-8.2-3.15-13.2s1.05-9.4,3.15-13.2c2.1-3.8,4.95-6.72,8.55-8.77,3.6-2.05,7.65-3.08,12.15-3.08,6.9,0,12.57,2.3,17.02,6.9,4.45,4.6,6.68,10.65,6.68,18.15s-2.23,13.55-6.68,18.15Z"}),f.jsx("path",{className:"cls-1",style:{fill:"#e7333c",strokeWidth:"0px"},d:"m313.22,71.7c0-8.2-1.72-15.42-5.17-21.67-3.45-6.25-8.25-11.1-14.4-14.55-6.15-3.45-13.12-5.17-20.92-5.17h-57.86c1.61.26,3.22.56,4.83.93,5.63,1.28,10.24,3,13.83,5.15l-7.37,14.6c-6.97-4.1-14.8-6.15-23.5-6.15-5.63,0-9.91.85-12.83,2.54-2.92,1.69-4.38,3.92-4.38,6.68,0,3.07,1.56,5.25,4.69,6.53,3.12,1.28,7.96,2.48,14.52,3.61,6.55,1.03,11.93,2.2,16.13,3.53,4.2,1.33,7.81,3.59,10.83,6.76,3.02,3.18,4.53,7.68,4.53,13.52,0,7.68-3.33,13.83-9.99,18.44-4.14,2.86-9.21,4.83-15.2,5.92h64.63c6.9,0,13.1-1.1,18.6-3.3,5.5-2.2,10.05-5.45,13.65-9.75l-10.05-11.55c-5.7,5.8-12.95,8.7-21.75,8.7-6.9,0-12.68-1.72-17.33-5.17-4.65-3.45-7.53-8.12-8.62-14.02h62.85c.2-2.4.3-4.25.3-5.55Zm-63.3-6.9c.9-5.9,3.43-10.62,7.58-14.17,4.15-3.55,9.22-5.32,15.22-5.32s11.2,1.8,15.3,5.4c4.1,3.6,6.55,8.3,7.35,14.1h-45.45Z"})]})]}),"tarafından geliştirilmiştir."]})]})})]})},bv=Lt`
  0% {
    transform: rotate(0deg);
  }
  100% {
