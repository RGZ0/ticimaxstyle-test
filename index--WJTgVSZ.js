 ...
 */var v1;function Gx(){if(v1)return nr;v1=1;var a=Symbol.for("react.transitional.element"),r=Symbol.for("react.fragment");function u(o,c,d){var p=null;if(d!==void 0&&(p=""+d),c.key!==void 0&&(p=""+c.key),"key"in c){d={};for(var m in c)m!=="key"&&(d[m]=c[m])}else d=c;return c=d.ref,{$$typeof:a,type:o,key:p,ref:c!==void 0?c:null,props:d}}return nr.Fragment=r,nr.jsx=u,nr.jsxs=u,nr}var S1;function $x(){return S1||(S1=1,kc.exports=Gx()),kc.exports}var f=$x(),Nc={exports:{}},ar={},Mc={exports:{}},Uc={};/**
 * @license React
...
`,hb=fe.button`
  ...
  /* Mobilde won modu: yatay şerit, sol altta */
  @media (max-width: 480px) {
    ${a=>a.won?`
      left: 10px;
      bottom: 16px;
  ...
  @media (max-width: 480px) {
    &:hover {
      transform: ${a=>a.won?"scale(1.03)":"translateY(-50%) translateX(5px)"};
    }
    &:active {
      transform: ${a=>a.won?"scale(0.97)":"translateY(-50%) translateX(2px) scale(0.98)"};
    }
...
`,pb=fe.div`
  ...
  @media (max-width: 768px) {
    left: ${a=>a.visible?"100px":"65px"};
    width: 210px;
    padding: 12px 14px;
  }

  /* Mobilde yatay buton altında açılır */
  @media (max-width: 480px) {
    left: 10px;
    bottom: 72px;
    top: auto;
