...
`,Jy=({color:a})=>{const[r,o]=G.useState(null),[u,f]=G.useState(!1),[d,p]=G.useState(!1),[g,w]=G.useState(!1),x=G.useRef(null);G.useEffect(()=>{x.current=document.querySelector("#upsell-ss-responsive"),w(!0)},[]);const{register:b,handleSubmit:D,formState:{errors:y}}=vr(),B=D(async H=>{p(!0),f(!1),o(null);try{const J=(await Le.post("https://api.upsell.co/ticimax/order",{phone:"90"+H.phone})).data;!J.data||J.data===null?f(!0):o(J.data)}catch{f(!0)}finally{p(!1)}}),A=()=>{o(null),f(!1)};return g&&x.current?_m.createPortal(c.jsx(Ky,{mainColor:a,children:c.jsxs(vo,{children:[c.jsx(zf,{mainColor:a}),c.jsx(Tf,{mainColor:a}),c.jsx(Af,{mainColor:a}),d&&c.jsx(wr,{children:c.jsx(Qy,{children:Array.from({length:8}).map((H,R)=>c.jsx("div",{},R))})}),r?c.jsxs(Ii,{children:[c.jsx(ai,{mainColor:a,children:"Sipariş Durumunu Sorgula"}),c.jsxs(vn,{children:[c.jsx("div",{style:{width:"50%"},children:"Sipariş No"}),c.jsx("div",{style:{width:"50%"},children:r.siparisNo||"-"})]}),c.jsxs(vn,{children:[c.jsx("div",{style:{width:"50%"},children:"Sipariş Tarihi"}),c.jsx("div",{style:{width:"50%"},children:new Date(r.siparisTarihi).toLocaleDateString("tr-TR")||"-"})]}),c.jsxs(vn,{children:[c.jsx("div",{style:{width:"50%"},children:"Sipariş Durumu"}),c.jsx("div",{style:{width:"50%"},children:r.siparisDurumu||"-"})]}),c.jsxs(vn,{children:[c.jsx("div",{style:{width:"50%"},children:"Kargo Takip Link"}),c.jsx("div",{style:{width:"50%"},children:r.kargoTakipLink?c.jsx("a",{target:"_blank",rel:"noopener noreferrer",style:{textDecoration:"none",color:a||"#e7333c"},href:r.kargoTakipLink,children:"Kargoyu Görüntüle"}):"-"})]}),c.jsxs(vn,{children:[c.jsx("div",{style:{width:"50%"},children:"Kargo Takip No"}),c.jsx("div",{style:{width:"50%"},children:r.kargoTakipNo||"-"})]}),c.jsxs(vn,{children:[c.jsx("div",{style:{width:"50%"},children:"Kargo Firma"}),c.jsx("div",{style:{width:"50%"},children:r.kargoFirmaTanim||"-"})]}),c.jsx("div",{children:c.jsx(hr,{mainColor:a,onClick:A,type:"button",children:"Yeni Sorgu Yap"})})]}):c.jsxs(Ii,{children:[c.jsx(ai,{mainColor:a,children:"Sipariş Durumunu Sorgula"}),c.jsx(Sr,{children:"Siparişinizin kargo takibini yapmak için telefon numaranızı giriniz."}),c.jsxs("form",{onSubmit:B,children:[c.jsx(ka,{mainColor:a,type:"tel",onInput:H=>{H.currentTarget.value=H.currentTarget.value.replace(/[^0-9]/g,"")},...b("phone",{required:"Telefon numarası boş bırakılamaz",pattern:{value:/^5[0-9]{9}$/,message:"Telefon numarası 5 ile başlamalı ve 10 haneli olmalıdır"},validate:H=>/^(\d)\1+$/.test(H)||/^5(\d)\1{8}$/.test(H)||H==="5123456789"||H==="5987654321"?"Geçersiz telefon numarası":!0}),placeholder:"5XXXXXXXXX",maxLength:10}),y.phone&&c.jsx(_t,{children:c.jsx("div",{style:{color:"red",fontSize:"14px",textAlign:"center"},children:y.phone.message})}),c.jsxs(go,{children:[c.jsx(xo,{mainColor:a,...b("kvkk",{required:"Lütfen bilgilerinizi paylaşmak için onay veriniz"}),type:"checkbox"}),c.jsxs("p",{style:{fontSize:"13px",lineHeight:"1.4",margin:0,color:"#666"},children:["Kampanya, duyuru ve bilgilendirmelerden E-Posta, WhatsApp ve SMS yoluyla haberdar olmak istediğimi belirtiyorum."," ",c.jsx("a",{style:{color:a||"#e7333c",textDecoration:"underline",fontWeight:"500"},href:"/UyelikSozlesme.aspx?sozlemeTipi=5",target:"_blank",rel:"noopener noreferrer",children:"Aydınlatma metni için tıklayın."})]})]}),y.kvkk&&c.jsx(_t,{children:c.jsx("div",{style:{color:"red",fontSize:"14px",textAlign:"center",marginBottom:"10px"},children:y.kvkk.message})}),u&&c.jsx(_t,{children:c.jsx("div",{style:{color:"red",fontSize:"14px",textAlign:"center"},children:"Telefon numarası ile eşleşen sipariş bulunamadı."})}),c.jsx("div",{children:c.jsx(hr,{mainColor:a,children:"Sorgula"})})]})]})]})}),x.current):null},Fy=It`
  0% {
    transform: rotate(0deg);
  }
  100% {
...
`,bv=()=>{const[a,r]=G.useState(null),[o,u]=G.useState(0),[f,d]=G.useState(1),[p,g]=G.useState(null),[w,x]=G.useState({d:"00",h:"00",m:"00",s:"00"}),b=G.useRef(null);if(G.useEffect(()=>{Le.get("https://api.upsell.co/shops/topbar").then(y=>{if(y.data.success){const B=y.data.data;if(B.targetDate){const A=new Date(B.targetDate).getTime()-new Date().getTime()<=0;g(A)}else g(!0);r(B)}})},[]),G.useEffect(()=>{if(!a||p||!b.current){document.body.style.paddingTop="0px",document.querySelectorAll("#headerNew, #header").forEach(B=>B.style.top="0px");return}const y=()=>{const B=b.current?.offsetHeight||0;document.body.style.paddingTop=B+"px",document.querySelectorAll("#headerNew, #header").forEach(A=>A.style.top=B+"px")};return setTimeout(y,50),window.addEventListener("resize",y),()=>{window.removeEventListener("resize",y)}},[a,p]),G.useEffect(()=>{if(!a||p)return;const y=[a.text,a.text2,a.text3].filter(Boolean),B=setInterval(()=>{d(0),setTimeout(()=>{u(A=>(A+1)%y.length),d(1)},300)},5e3);return()=>clearInterval(B)},[a,p]),G.useEffect(()=>{if(!a?.targetDate||p)return;const y=setInterval(()=>{const B=new Date(a.targetDate).getTime()-new Date().getTime();if(B<=0){g(!0),clearInterval(y);return}x({d:Math.floor(B/864e5).toString().padStart(2,"0"),h:Math.floor(B%864e5/36e5).toString().padStart(2,"0"),m:Math.floor(B%36e5/6e4).toString().padStart(2,"0"),s:Math.floor(B%6e4/1e3).toString().padStart(2,"0")})},1e3);return()=>clearInterval(y)},[a,p]),!a||p!==!1)return null;const D=[a.text,a.text2,a.text3].filter(Boolean);return c.jsx(vv,{bgColor:a.backgroundColor,txtColor:a.textColor,children:c.jsx("a",{ref:b,className:"upsell-topbar-main",href:a.url||"#",target:"_blank",children:c.jsxs("div",{className:"upsell-topbar-content",children:[c.jsx("div",{className:"upsell-topbar-left",children:c.jsx("div",{className:"upsell-topbar-text",style:{opacity:f},children:D[o]})}),c.jsx("div",{className:"upsell-topbar-divider"}),c.jsx("div",{className:"upsell-topbar-right",children:c.jsxs("div",{className:"upsell-topbar-timer-wrapper",style:{display:"flex",alignItems:"center"},children:[c.jsx("span",{style:{fontSize:"12px",opacity:.8,marginRight:"4px"},children:"Bitişe:"}),c.jsxs("div",{className:"upsell-topbar-timer-box",children:[c.jsx("span",{className:"upsell-timer-val",children:w.d}),c.jsx("span",{className:"upsell-timer-lbl",children:"Gün"})]}),c.jsxs("div",{className:"upsell-topbar-timer-box",children:[c.jsx("span",{className:"upsell-timer-val",children:w.h}),c.jsx("span",{className:"upsell-timer-lbl",children:"Saat"})]}),c.jsxs("div",{className:"upsell-topbar-timer-box",children:[c.jsx("span",{className:"upsell-timer-val",children:w.m}),c.jsx("span",{className:"upsell-timer-lbl",children:"Dak"})]}),c.jsxs("div",{className:"upsell-topbar-timer-box",children:[c.jsx("span",{className:"upsell-timer-val",children:w.s}),c.jsx("span",{className:"upsell-timer-lbl",children:"Sn"})]})]})})]})})})};function Sv(){const[a,r]=G.useState(),[o,u]=G.useState(!1);return G.useEffect(()=>{async function f(){u(!0);try{const d=document.querySelector(".ProductBody")!==null,p=await Le.get("https://api.upsell.co/Shops");if(p.data&&p.data.success&&p.data.data){const g=p.data.data;r({mainColor:g.mainColor||"#e7333c",logo:g.logo||"",enabledPhoneSubscription:g.enabledPhoneSubscription||!1,enabledEmailSubscription:g.enabledEmailSubscription||!1,enabledGiftWheel:g.enabledGiftWheel||!1,enabledProductStat:(g.enabledProductStat||!1)&&d,enabledOrderCheck:g.enabledOrderCheck||!1,enabledWeeklyProducts:g.enabledWeeklyProducts||!1,enabledStockReminder:g.enabledStockReminder||!1,enabledSizeChart:g.enabledSizeChart||!1,enabledCategoryProducts:g.enabledCategoryProducts||!1,enabledTopBar:g.enabledTopBar||!1,useOneChartForAllProducts:g.useOneChartForAllProducts||!1,stockReminderUsageChannel:g.stockReminderUsageChannel||1})}else console.error("API'den geçersiz veri formatı geldi")}catch(d){console.error("API çağrısı başarısız:",d)}finally{u(!1)}}f()},[]),G.useEffect(()=>{const f=new URLSearchParams(window.location.search),d=f.get("utm_source"),p=f.get("utm_medium"),g=f.get("utm_campaign");if(!(d==="upsell"))return;const x="uvid",b=localStorage.getItem(x),D=b||crypto.randomUUID();b||localStorage.setItem(x,D),Le.post("https://api.upsell.co/Tracking/CreateVisitor",{visitorId:D,path:window.location.pathname,productId:String(window.productDetailModel?.product.urunKartiId),utm:{source:d,medium:p,campaign:g}}).catch(()=>{})},[]),G.useEffect(()=>{const f="uvid",d=localStorage.getItem(f);if(!d)return;const p=window,g=p.orderCompletedModel,w=p.checkout_order,x=g?.orderId??w?.id??w?.orderId??null;x&&Le.post("https://api.upsell.co/Tracking/MatchOrder",{visitorId:d,orderId:String(x)}).then(()=>{localStorage.removeItem(f)}).catch(()=>{})},[]),o?c.jsx("div",{children:"Yükleniyor..."}):a?a.mainColor?a.logo?c.jsxs(c.Fragment,{children:[a.enabledTopBar&&c.jsx(bv,{}),a.enabledCategoryProducts&&c.jsx(My,{}),a.enabledWeeklyProducts&&c.jsx(Sy,{mainColor:a.mainColor}),(a.enabledPhoneSubscription||a.enabledEmailSubscription)&&c.jsx(ty,{mainColor:a.mainColor,enabledPhoneSubscription:a.enabledPhoneSubscription,enabledEmailSubscription:a.enabledEmailSubscription}),a.enabledGiftWheel&&c.jsx(hv,{mainColor:a.mainColor}),a.enabledProductStat&&c.jsx(yv,{mainColor:a.mainColor}),a.enabledOrderCheck&&c.jsxs(c.Fragment,{children:[c.jsx(Ay,{color:a.mainColor}),c.jsx(Jy,{})]}),a.enabledStockReminder&&c.jsx(Ny,{mainColor:a.mainColor,stockReminderUsageChannel:a.stockReminderUsageChannel}),a.enabledSizeChart&&a.useOneChartForAllProducts!==void 0&&c.jsx(Xy,{useOneChartForAllProducts:a.useOneChartForAllProducts})]}):c.jsx("div",{children:"Mağaza logo bilgisi eksik"}):c.jsx("div",{children:"Mağaza renk bilgisi eksik"}):c.jsx("div",{children:"Mağaza bilgileri yüklenemedi"})}const Sp=document.getElementById("upsell-style");Sp&&Fx.createRoot(Sp).render(c.jsx(Sv,{}));
