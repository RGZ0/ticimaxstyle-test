 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var hh;function Xx(){return hh||(hh=1,(function(a){function r(_,K){var ft=_.length;_.push(K);t:for(;0<ft;){var bt=ft-1>>>1,S=_[bt];if(0<c(S,K))_[bt]=K,_[ft]=S,ft=bt;else break t}}function o(_){return _.length===0?null:_[0]}function u(_){if(_.length===0)return null;var K=_[0],ft=_.pop();if(ft!==K){_[0]=ft;t:for(var bt=0,S=_.length,L=S>>>1;bt<L;){var nt=2*(bt+1)-1,q=_[nt],F=nt+1,ot=_[F];if(0>c(q,ft))F<S&&0>c(ot,q)?(_[bt]=ot,_[F]=ft,bt=F):(_[bt]=q,_[nt]=ft,bt=nt);else if(F<S&&0>c(ot,ft))_[bt]=ot,_[F]=ft,bt=F;else break t}}return K}function c(_,K){var ft=_.sortIndex-K.sortIndex;return ft!==0?ft:_.id-K.id}if(a.unstable_now=void 0,typeof performance=="object"&&typeof performance.now=="function"){var d=performance;a.unstable_now=function(){return d.now()}}else{var p=Date,g=p.now();a.unstable_now=function(){return p.now()-g}}var w=[],x=[],b=1,O=null,E=3,Z=!1,D=!1,B=!1,M=!1,tt=typeof setTimeout=="function"?setTimeout:null,V=typeof clearTimeout=="function"?clearTimeout:null,Q=typeof setImmediate<"u"?setImmediate:null;function rt(_){for(var K=o(x);K!==null;){if(K.callback===null)u(x);else if(K.startTime<=_)u(x),K.sortIndex=K.expirationTime,r(w,K);else break;K=o(x)}}function H(_){if(B=!1,rt(_),!D)if(o(w)!==null)D=!0,et||(et=!0,I());else{var K=o(x);K!==null&&yt(H,K.startTime-_)}}var et=!1,J=-1,lt=5,zt=-1;function Yt(){return M?!0:!(a.unstable_now()-zt<lt)}function Ct(){if(M=!1,et){var _=a.unstable_now();zt=_;var K=!0;try{t:{D=!1,B&&(B=!1,V(J),J=-1),Z=!0;var ft=E;try{e:{for(rt(_),O=o(w);O!==null&&!(O.expirationTime>_&&Yt());){var bt=O.callback;if(typeof bt=="function"){O.callback=null,E=O.priorityLevel;var S=bt(O.expirationTime<=_);if(_=a.unstable_now(),typeof S=="function"){O.callback=S,rt(_),K=!0;break e}O===o(w)&&u(w),rt(_)}else u(w);O=o(w)}if(O!==null)K=!0;else{var L=o(x);L!==null&&yt(H,L.startTime-_),K=!1}}break t}finally{O=null,E=ft,Z=!1}K=void 0}}finally{K?I():et=!1}}}var I;if(typeof Q=="function")I=function(){Q(Ct)};else if(typeof MessageChannel<"u"){var st=new MessageChannel,xt=st.port2;st.port1.onmessage=Ct,I=function(){xt.postMessage(null)}}else I=function(){tt(Ct,0)};function yt(_,K){J=tt(function(){_(a.unstable_now())},K)}a.unstable_IdlePriority=5,a.unstable_ImmediatePriority=1,a.unstable_LowPriority=4,a.unstable_NormalPriority=3,a.unstable_Profiling=null,a.unstable_UserBlockingPriority=2,a.unstable_cancelCallback=function(_){_.callback=null},a.unstable_forceFrameRate=function(_){0>_||125<_?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):lt=0<_?Math.floor(1e3/_):5},a.unstable_getCurrentPriorityLevel=function(){return E},a.unstable_next=function(_){switch(E){case 1:case 2:case 3:var K=3;break;default:K=E}var ft=E;E=K;try{return _()}finally{E=ft}},a.unstable_requestPaint=function(){M=!0},a.unstable_runWithPriority=function(_,K){switch(_){case 1:case 2:case 3:case 4:case 5:break;default:_=3}var ft=E;E=_;try{return K()}finally{E=ft}},a.unstable_scheduleCallback=function(_,K,ft){var bt=a.unstable_now();switch(typeof ft=="object"&&ft!==null?(ft=ft.delay,ft=typeof ft=="number"&&0<ft?bt+ft:bt):ft=bt,_){case 1:var S=-1;break;case 2:S=250;break;case 5:S=1073741823;break;case 4:S=1e4;break;default:S=5e3}return S=ft+S,_={id:b++,callback:K,priorityLevel:_,startTime:ft,expirationTime:S,sortIndex:-1},ft>bt?(_.sortIndex=ft,r(x,_),o(w)===null&&_===o(x)&&(B?(V(J),J=-1):B=!0,yt(H,ft-bt))):(_.sortIndex=S,r(w,_),D||Z||(D=!0,et||(et=!0,I()))),_},a.unstable_shouldYield=Yt,a.unstable_wrapCallback=function(_){var K=E;return function(){var ft=E;E=K;try{return _.apply(this,arguments)}finally{E=ft}}}})(kc)),kc}var ph;function Zx(){return ph||(ph=1,Dc.exports=Xx()),Dc.exports}var Rc={exports:{}},_t={};/**
 * @license React
 * react.production.js
 *
 * Copyright (c) Meta Platforms, Inc. and affiliates.
