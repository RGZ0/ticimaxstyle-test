 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var mh;function $x(){if(mh)return _t;mh=1;var a=Symbol.for("react.transitional.element"),r=Symbol.for("react.portal"),o=Symbol.for("react.fragment"),u=Symbol.for("react.strict_mode"),c=Symbol.for("react.profiler"),d=Symbol.for("react.consumer"),p=Symbol.for("react.context"),g=Symbol.for("react.forward_ref"),w=Symbol.for("react.suspense"),x=Symbol.for("react.memo"),y=Symbol.for("react.lazy"),T=Symbol.iterator;function z(S){return S===null||typeof S!="object"?null:(S=T&&S[T]||S["@@iterator"],typeof S=="function"?S:null)}var J={isMounted:function(){return!1},enqueueForceUpdate:function(){},enqueueReplaceState:function(){},enqueueSetState:function(){}},k=Object.assign,H={};function M(S,L,nt){this.props=S,this.context=L,this.refs=H,this.updater=nt||J}M.prototype.isReactComponent={},M.prototype.setState=function(S,L){if(typeof S!="object"&&typeof S!="function"&&S!=null)throw Error("takes an object of state variables to update or a function which returns an object of state variables.");this.updater.enqueueSetState(this,S,L,"setState")},M.prototype.forceUpdate=function(S){this.updater.enqueueForceUpdate(this,S,"forceUpdate")};function P(){}P.prototype=M.prototype;function Y(S,L,nt){this.props=S,this.context=L,this.refs=H,this.updater=nt||J}var $=Y.prototype=new P;$.constructor=Y,k($,M.prototype),$.isPureReactComponent=!0;var rt=Array.isArray,B={H:null,A:null,T:null,S:null,V:null},et=Object.prototype.hasOwnProperty;function K(S,L,nt,q,W,ot){return nt=ot.ref,{$$typeof:a,type:S,key:L,ref:nt!==void 0?nt:null,props:ot}}function lt(S,L){return K(S.type,L,void 0,void 0,void 0,S.props)}function zt(S){return typeof S=="object"&&S!==null&&S.$$typeof===a}function Yt(S){var L={"=":"=0",":":"=2"};return"$"+S.replace(/[=:]/g,function(nt){return L[nt]})}var Ct=/\/+/g;function I(S,L){return typeof S=="object"&&S!==null&&S.key!=null?Yt(""+S.key):L.toString(36)}function st(){}function xt(S){switch(S.status){case"fulfilled":return S.value;case"rejected":throw S.reason;default:switch(typeof S.status=="string"?S.then(st,st):(S.status="pending",S.then(function(L){S.status==="pending"&&(S.status="fulfilled",S.value=L)},function(L){S.status==="pending"&&(S.status="rejected",S.reason=L)})),S.status){case"fulfilled":return S.value;case"rejected":throw S.reason}}throw S}function yt(S,L,nt,q,W){var ot=typeof S;(ot==="undefined"||ot==="boolean")&&(S=null);var ut=!1;if(S===null)ut=!0;else switch(ot){case"bigint":case"string":case"number":ut=!0;break;case"object":switch(S.$$typeof){case a:case r:ut=!0;break;case y:return ut=S._init,yt(ut(S._payload),L,nt,q,W)}}if(ut)return W=W(S),ut=q===""?"."+I(S,0):q,rt(W)?(nt="",ut!=null&&(nt=ut.replace(Ct,"$&/")+"/"),yt(W,L,nt,"",function(kt){return kt})):W!=null&&(zt(W)&&(W=lt(W,nt+(W.key==null||S&&S.key===W.key?"":(""+W.key).replace(Ct,"$&/")+"/")+ut)),L.push(W)),1;ut=0;var gt=q===""?".":q+":";if(rt(S))for(var pt=0;pt<S.length;pt++)q=S[pt],ot=gt+I(q,pt),ut+=yt(q,L,nt,ot,W);else if(pt=z(S),typeof pt=="function")for(S=pt.call(S),pt=0;!(q=S.next()).done;)q=q.value,ot=gt+I(q,pt++),ut+=yt(q,L,nt,ot,W);else if(ot==="object"){if(typeof S.then=="function")return yt(xt(S),L,nt,q,W);throw L=String(S),Error("Objects are not valid as a React child (found: "+(L==="[object Object]"?"object with keys {"+Object.keys(S).join(", ")+"}":L)+"). If you meant to render a collection of children, use an array instead.")}return ut}function _(S,L,nt){if(S==null)return S;var q=[],W=0;return yt(S,q,"","",function(ot){return L.call(nt,ot,W++)}),q}function Q(S){if(S._status===-1){var L=S._result;L=L(),L.then(function(nt){(S._status===0||S._status===-1)&&(S._status=1,S._result=nt)},function(nt){(S._status===0||S._status===-1)&&(S._status=2,S._result=nt)}),S._status===-1&&(S._status=0,S._result=L)}if(S._status===1)return S._result.default;throw S._result}var ft=typeof reportError=="function"?reportError:function(S){if(typeof window=="object"&&typeof window.ErrorEvent=="function"){var L=new window.ErrorEvent("error",{bubbles:!0,cancelable:!0,message:typeof S=="object"&&S!==null&&typeof S.message=="string"?String(S.message):String(S),error:S});if(!window.dispatchEvent(L))return}else if(typeof process=="object"&&typeof process.emit=="function"){process.emit("uncaughtException",S);return}console.error(S)};function bt(){}return _t.Children={map:_,forEach:function(S,L,nt){_(S,function(){L.apply(this,arguments)},nt)},count:function(S){var L=0;return _(S,function(){L++}),L},toArray:function(S){return _(S,function(L){return L})||[]},only:function(S){if(!zt(S))throw Error("React.Children.only expected to receive a single React element child.");return S}},_t.Component=M,_t.Fragment=o,_t.Profiler=c,_t.PureComponent=Y,_t.StrictMode=u,_t.Suspense=w,_t.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE=B,_t.__COMPILER_RUNTIME={__proto__:null,c:function(S){return B.H.useMemoCache(S)}},_t.cache=function(S){return function(){return S.apply(null,arguments)}},_t.cloneElement=function(S,L,nt){if(S==null)throw Error("The argument must be a React element, but you passed "+S+".");var q=k({},S.props),W=S.key,ot=void 0;if(L!=null)for(ut in L.ref!==void 0&&(ot=void 0),L.key!==void 0&&(W=""+L.key),L)!et.call(L,ut)||ut==="key"||ut==="__self"||ut==="__source"||ut==="ref"&&L.ref===void 0||(q[ut]=L[ut]);var ut=arguments.length-2;if(ut===1)q.children=nt;else if(1<ut){for(var gt=Array(ut),pt=0;pt<ut;pt++)gt[pt]=arguments[pt+2];q.children=gt}return K(S.type,W,void 0,void 0,ot,q)},_t.createContext=function(S){return S={$$typeof:p,_currentValue:S,_currentValue2:S,_threadCount:0,Provider:null,Consumer:null},S.Provider=S,S.Consumer={$$typeof:d,_context:S},S},_t.createElement=function(S,L,nt){var q,W={},ot=null;if(L!=null)for(q in L.key!==void 0&&(ot=""+L.key),L)et.call(L,q)&&q!=="key"&&q!=="__self"&&q!=="__source"&&(W[q]=L[q]);var ut=arguments.length-2;if(ut===1)W.children=nt;else if(1<ut){for(var gt=Array(ut),pt=0;pt<ut;pt++)gt[pt]=arguments[pt+2];W.children=gt}if(S&&S.defaultProps)for(q in ut=S.defaultProps,ut)W[q]===void 0&&(W[q]=ut[q]);return K(S,ot,void 0,void 0,null,W)},_t.createRef=function(){return{current:null}},_t.forwardRef=function(S){return{$$typeof:g,render:S}},_t.isValidElement=zt,_t.lazy=function(S){return{$$typeof:y,_payload:{_status:-1,_result:S},_init:Q}},_t.memo=function(S,L){return{$$typeof:x,type:S,compare:L===void 0?null:L}},_t.startTransition=function(S){var L=B.T,nt={};B.T=nt;try{var q=S(),W=B.S;W!==null&&W(nt,q),typeof q=="object"&&q!==null&&typeof q.then=="function"&&q.then(bt,ft)}catch(ot){ft(ot)}finally{B.T=L}},_t.unstable_useCacheRefresh=function(){return B.H.useCacheRefresh()},_t.use=function(S){return B.H.use(S)},_t.useActionState=function(S,L,nt){return B.H.useActionState(S,L,nt)},_t.useCallback=function(S,L){return B.H.useCallback(S,L)},_t.useContext=function(S){return B.H.useContext(S)},_t.useDebugValue=function(){},_t.useDeferredValue=function(S,L){return B.H.useDeferredValue(S,L)},_t.useEffect=function(S,L,nt){var q=B.H;if(typeof nt=="function")throw Error("useEffect CRUD overload is not enabled in this build of React.");return q.useEffect(S,L)},_t.useId=function(){return B.H.useId()},_t.useImperativeHandle=function(S,L,nt){return B.H.useImperativeHandle(S,L,nt)},_t.useInsertionEffect=function(S,L){return B.H.useInsertionEffect(S,L)},_t.useLayoutEffect=function(S,L){return B.H.useLayoutEffect(S,L)},_t.useMemo=function(S,L){return B.H.useMemo(S,L)},_t.useOptimistic=function(S,L){return B.H.useOptimistic(S,L)},_t.useReducer=function(S,L,nt){return B.H.useReducer(S,L,nt)},_t.useRef=function(S){return B.H.useRef(S)},_t.useState=function(S){return B.H.useState(S)},_t.useSyncExternalStore=function(S,L,nt){return B.H.useSyncExternalStore(S,L,nt)},_t.useTransition=function(){return B.H.useTransition()},_t.version="19.1.1",_t}var gh;function sf(){return gh||(gh=1,Rc.exports=$x()),Rc.exports}var Cc={exports:{}},Ue={};/**
 * @license React
...
`,My=({mainColor:a,stockReminderUsageChannel:r,forceOpen:o})=>{const u=G.useRef(null),[c,d]=G.useState(o||!1),[p,g]=G.useState(!1),[w,x]=G.useState(""),[y,T]=G.useState(!1),[z,J]=G.useState(),[k,H]=G.useState(),[M,P]=G.useState(!1),[Y,$]=G.useState(!1),[rt,B]=G.useState(null),et=G.useRef(null),K=G.useRef(null),lt=G.useRef(null),zt=()=>{document.querySelectorAll(".nostok").forEach(W=>{if(!W.querySelector(".stock_bell_icon")){const ot=document.createElementNS("http://www.w3.org/2000/svg","svg");ot.setAttribute("class","stock_bell_icon"),ot.setAttribute("height","18"),ot.setAttribute("width","18"),ot.setAttribute("viewBox","0 0 512 512"),ot.style.pointerEvents="none";const ut=document.createElementNS("http://www.w3.org/2000/svg","g");["m437.017 39.687c-5.858-5.857-15.356-5.857-21.213 0-5.858 5.858-5.857 15.356 0 21.213 42.688 42.685 66.196 99.438 66.196 159.807 0 8.284 6.716 15 15 15s15-6.716 15-15c0-68.382-26.629-132.67-74.983-181.02z","m96.193 39.688c-5.858-5.857-15.355-5.858-21.213 0-48.352 48.354-74.98 112.641-74.98 181.019 0 8.284 6.716 15 15 15s15-6.716 15-15c0-60.365 23.508-117.118 66.193-159.805 5.858-5.858 5.858-15.356 0-21.214z","m370.358 85.125c-5.858 5.858-5.857 15.355 0 21.213 30.55 30.548 47.374 71.164 47.374 114.368 0 8.284 6.716 15 15 15s15-6.716 15-15c0-51.217-19.945-99.368-56.161-135.582-5.858-5.856-15.355-5.856-21.213.001z","m141.634 85.132c-5.858-5.857-15.356-5.857-21.213.001-36.211 36.216-56.154 84.363-56.154 135.573 0 8.284 6.716 15 15 15s15-6.716 15-15c0-43.197 16.823-83.811 47.369-114.361 5.857-5.858 5.856-15.355-.002-21.213z","m383.467 329.632v-76.792c0-28.011-8.918-54.59-25.79-76.865-14.101-18.617-33.332-33.16-54.939-41.717-3.007-23.111-22.82-41.018-46.738-41.018s-43.733 17.906-46.74 41.018c-21.606 8.558-40.837 23.101-54.938 41.717-16.872 22.275-25.79 48.854-25.79 76.865v76.792l-30.549 61.1c-2.325 4.65-2.076 10.172.657 14.594s7.561 7.114 12.76 7.114h66.774c7.033 36.558 39.246 64.267 77.825 64.267 38.578 0 70.791-27.709 77.823-64.267h66.778c5.199 0 10.027-2.692 12.76-7.114s2.981-9.944.657-14.594zm-127.467 117.075c-21.938 0-40.573-14.413-46.933-34.267h93.865c-6.36 19.854-24.994 34.267-46.932 34.267zm64.266-64.267h-128.533-56.062l21.279-42.559c1.042-2.083 1.583-4.379 1.583-6.708v-80.333c0-42.793 28.625-81.203 69.612-93.405 6.36-1.894 10.72-7.741 10.72-14.376v-4.686c0-9.447 7.687-17.133 17.135-17.133 9.447 0 17.133 7.686 17.133 17.133v4.686c0 6.636 4.36 12.483 10.72 14.376 40.987 12.202 69.614 50.611 69.614 93.405v80.333c0 2.329.542 4.625 1.583 6.708l21.279 42.559z"].forEach(pt=>{const kt=document.createElementNS("http://www.w3.org/2000/svg","path");kt.setAttribute("d",pt),ut.appendChild(kt)}),ot.appendChild(ut),W.appendChild(ot)}})},Yt=()=>{lt.current&&clearInterval(lt.current),lt.current=setInterval(()=>{document.querySelectorAll(".stock_bell_icon").forEach(W=>{const ot=W;ot.classList.add("bell-animate"),setTimeout(()=>{ot.classList.remove("bell-animate")},1e3)})},3e3)},Ct=()=>{const q=document.getElementById("dynamicNostokBellStyles");q&&q.remove();const W=document.createElement("style");W.id="dynamicNostokBellStyles",W.innerHTML=`
    ...
    `,document.head.appendChild(W)};G.useEffect(()=>{typeof window<"u"&&(window.currentProduct?J(window.currentProduct):window.productDetailModel&&J(window.productDetailModel))},[]),G.useEffect(()=>(Ct(),()=>{const q=document.getElementById("dynamicNostokBellStyles");q&&q.remove()}),[a]),G.useEffect(()=>{typeof window<"u"&&z&&(zt(),Yt())},[z]),G.useEffect(()=>()=>{lt.current&&clearInterval(lt.current)},[]);const{register:I,handleSubmit:st,formState:{errors:xt},reset:yt,clearErrors:_}=br(),Q=()=>{d(!1),H(null),$(!1),B(null),yt(),_(),x(""),P(!1)};u!==null&&nl(u,Q);const ft=st(q=>{g(!0),z&&(z.productVariantData&&!k||qt.post("https://api.upsell.co/phonesubscription/reminder",{...r===1||r===2?{phone:"90"+q.phone,email:""}:{email:q.email,phone:""},productName:z.productName,productSlug:window.location.pathname,productId:`${z.productVariantData?k?.variantOptions[0].urunID:z.product.id}`,productCardId:z.product.urunKartiId.toString(),variant:(JSON.stringify(k)??"{}")||"{}",hasVariant:z.productVariantData!==null}).then(()=>{T(!0),d(!1)}).catch(()=>{x(r===1||r===2?"Bu telefon numarası zaten kayıtlı.":"Bu e-posta adresi zaten kayıtlı.")}).finally(()=>{g(!1)}))});G.useEffect(()=>{if(o)d(!0);else if(typeof window<"u"){const q=gt=>{gt.preventDefault(),gt.stopPropagation();const pt=gt.currentTarget;let kt=pt.getAttribute("data-variant-definition");if(!kt){const ae=pt.querySelector("[data-variant-definition]");ae&&(kt=ae.getAttribute("data-variant-definition"))}B(kt),c||d(!0)},W=()=>{c||d(!0)};et.current=q,K.current=W;const ot=document.getElementById("upsell-ss-reminder");ot&&(ot.removeEventListener("click",K.current),ot.addEventListener("click",W));const ut=document.querySelectorAll(".nostok");if(ut.forEach(gt=>{et.current&&gt.removeEventListener("click",et.current)}),ut.forEach(gt=>{gt.addEventListener("click",q)}),z){const gt=z.productVariantData?.some(ae=>ae.stokAdedi===0),pt=z.productVariantData===null&&z.totalStockAmount===0;if(gt||pt){const ae=z.productVariantData!==null&&z.totalStockAmount===0;if(ut.length===0||ae)if(ot)ot.style.display="flex";else{const ve=()=>{if(typeof window.$<"u"){const St=document.querySelector(".MiddleList");if(St&&!document.getElementById("upsell-ss-reminder")){const vt=`
        ...
        .bs-fav-btn:hover { background: #fee; color: #d32f2f; }
        ...
        /* Sepete Ekle Butonu (Link Görünümü) */
        .bs-add-cart {
          width: 100%;
          background: #1a1a1a;
          color: #fff !important; /* Link rengini override et */
          border: none;
          padding: 10px;
          border-radius: 6px;
          font-size: 13px;
        ...
        .bs-widget-container .owl-prev { left: -15px; }
        .bs-widget-container .owl-next { right: -15px; }

        @media (max-width: 768px) {
           .bs-widget-container .owl-prev { left: 0; }
           .bs-widget-container .owl-next { right: 0; }
           .bs-title { font-size: 13px; height: 36px; }
           .bs-new-price { font-size: 16px; }
           .bs-add-cart span { display: none; } /* Mobilde sadece ikon */
           .bs-add-cart { padding: 8px; }
        }
      `}}),f.jsx("div",{className:"bs-head-wrap",children:f.jsxs("h2",{className:"bs-heading",children:[f.jsx("i",{className:"fas fa-crown"}),"Kategorinin En Çok Satanları"]})}),f.jsx("div",{ref:d,className:"owl-carousel owl-theme",children:r.map(y=>x(y))})]}),p.current)},Uy=F.div`
  position: fixed;
  top: 0;
  left: 0;
  z-index: 9999;
