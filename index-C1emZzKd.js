 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var wh;function $x(){return wh||(wh=1,function(l){function r(_,J){var he=_.length;_.push(J);e:for(;0<he;){var be=he-1>>>1,v=_[be];if(0<c(v,J))_[be]=J,_[he]=v,he=be;else break e}}function u(_){return _.length===0?null:_[0]}function o(_){if(_.length===0)return null;var J=_[0],he=_.pop();if(he!==J){_[0]=he;e:for(var be=0,v=_.length,$=v>>>1;be<$;){var ae=2*(be+1)-1,U=_[ae],X=ae+1,le=_[X];if(0>c(U,he))X<v&&0>c(le,U)?(_[be]=le,_[X]=he,be=X):(_[be]=U,_[ae]=he,be=ae);else if(X<v&&0>c(le,he))_[be]=le,_[X]=he,be=X;else break e}}return J}function c(_,J){var he=_.sortIndex-J.sortIndex;return he!==0?he:_.id-J.id}if(l.unstable_now=void 0,typeof performance=="object"&&typeof performance.now=="function"){var d=performance;l.unstable_now=function(){return d.now()}}else{var p=Date,m=p.now();l.unstable_now=function(){return p.now()-m}}var y=[],x=[],b=1,C=null,T=3,O=!1,k=!1,B=!1,D=!1,V=typeof setTimeout=="function"?setTimeout:null,R=typeof clearTimeout=="function"?clearTimeout:null,Q=typeof setImmediate<"u"?setImmediate:null;function re(_){for(var J=u(x);J!==null;){if(J.callback===null)o(x);else if(J.startTime<=_)o(x),J.sortIndex=J.expirationTime,r(y,J);else break;J=u(x)}}function Y(_){if(B=!1,re(_),!k)if(u(y)!==null)k=!0,oe||(oe=!0,P());else{var J=u(x);J!==null&&me(Y,J.startTime-_)}}var oe=!1,F=-1,te=5,Ee=-1;function Oe(){return D?!0:!(l.unstable_now()-Ee<te)}function ve(){if(D=!1,oe){var _=l.unstable_now();Ee=_;var J=!0;try{e:{k=!1,B&&(B=!1,R(F),F=-1),O=!0;var he=T;try{t:{for(re(_),C=u(y);C!==null&&!(C.expirationTime>_&&Oe());){var be=C.callback;if(typeof be=="function"){C.callback=null,T=C.priorityLevel;var v=be(C.expirationTime<=_);if(_=l.unstable_now(),typeof v=="function"){C.callback=v,re(_),J=!0;break t}C===u(y)&&o(y),re(_)}else o(y);C=u(y)}if(C!==null)J=!0;else{var $=u(x);$!==null&&me(Y,$.startTime-_),J=!1}}break e}finally{C=null,T=he,O=!1}J=void 0}}finally{J?P():oe=!1}}}var P;if(typeof Q=="function")P=function(){Q(ve)};else if(typeof MessageChannel<"u"){var ie=new MessageChannel,ue=ie.port2;ie.port1.onmessage=ve,P=function(){ue.postMessage(null)}}else P=function(){V(ve,0)};function me(_,J){F=V(function(){_(l.unstable_now())},J)}l.unstable_IdlePriority=5,l.unstable_ImmediatePriority=1,l.unstable_LowPriority=4,l.unstable_NormalPriority=3,l.unstable_Profiling=null,l.unstable_UserBlockingPriority=2,l.unstable_cancelCallback=function(_){_.callback=null},l.unstable_forceFrameRate=function(_){0>_||125<_?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):te=0<_?Math.floor(1e3/_):5},l.unstable_getCurrentPriorityLevel=function(){return T},l.unstable_next=function(_){switch(T){case 1:case 2:case 3:var J=3;break;default:J=T}var he=T;T=J;try{return _()}finally{T=he}},l.unstable_requestPaint=function(){D=!0},l.unstable_runWithPriority=function(_,J){switch(_){case 1:case 2:case 3:case 4:case 5:break;default:_=3}var he=T;T=_;try{return J()}finally{T=he}},l.unstable_scheduleCallback=function(_,J,he){var be=l.unstable_now();switch(typeof he=="object"&&he!==null?(he=he.delay,he=typeof he=="number"&&0<he?be+he:be):he=be,_){case 1:var v=-1;break;case 2:v=250;break;case 5:v=1073741823;break;case 4:v=1e4;break;default:v=5e3}return v=he+v,_={id:b++,callback:J,priorityLevel:_,startTime:he,expirationTime:v,sortIndex:-1},he>be?(_.sortIndex=he,r(x,_),u(y)===null&&_===u(x)&&(B?(R(F),F=-1):B=!0,me(Y,he-be))):(_.sortIndex=v,r(y,_),k||O||(k=!0,oe||(oe=!0,P()))),_},l.unstable_shouldYield=Oe,l.unstable_wrapCallback=function(_){var J=T;return function(){var he=T;T=J;try{return _.apply(this,arguments)}finally{T=he}}}}(Uc)),Uc}var Eh;function Xx(){return Eh||(Eh=1,Mc.exports=$x()),Mc.exports}var Bc={exports:{}},Ce={};/**
 * @license React
 * react.production.js
 *
 * Copyright (c) Meta Platforms, Inc. and affiliates.
...
`,W5=({color:l})=>{const[r,u]=G.useState(null),[o,c]=G.useState(!1),[d,p]=G.useState(!1),[m,y]=G.useState(!1),x=G.useRef(null);G.useEffect(()=>{x.current=document.querySelector("#upsell-ss-responsive"),y(!0)},[]);const{register:b,handleSubmit:C,formState:{errors:T}}=jr(),O=C(async B=>{p(!0),c(!1),u(null);try{const V=(await He.post("https://api.upsell.co/ticimax/order",{phone:"90"+B.phone})).data;!V.data||V.data===null?c(!0):u(V.data)}catch{c(!0)}finally{p(!1)}}),k=()=>{u(null),c(!1)};return m&&x.current?Uf.createPortal(f.jsx(J5,{mainColor:l,children:f.jsxs(Ao,{children:[d&&f.jsx(_r,{children:f.jsx(F5,{children:Array.from({length:8}).map((B,D)=>f.jsx("div",{},D))})}),r?f.jsxs(ti,{children:[f.jsx(fa,{mainColor:l,children:"Sipariş Durumunu Sorgula"}),f.jsxs(yn,{children:[f.jsx("div",{style:{width:"50%"},children:"Sipariş No"}),f.jsx("div",{style:{width:"50%"},children:r.siparisNo||"-"})]}),f.jsxs(yn,{children:[f.jsx("div",{style:{width:"50%"},children:"Sipariş Tarihi"}),f.jsx("div",{style:{width:"50%"},children:new Date(r.siparisTarihi).toLocaleDateString("tr-TR")||"-"})]}),f.jsxs(yn,{children:[f.jsx("div",{style:{width:"50%"},children:"Sipariş Durumu"}),f.jsx("div",{style:{width:"50%"},children:r.siparisDurumu||"-"})]}),f.jsxs(yn,{children:[f.jsx("div",{style:{width:"50%"},children:"Kargo Takip Link"}),f.jsx("div",{style:{width:"50%"},children:r.kargoTakipLink?f.jsx("a",{target:"_blank",rel:"noopener noreferrer",style:{textDecoration:"none",color:l||"#e7333c"},href:r.kargoTakipLink,children:"Kargoyu Görüntüle"}):"-"})]}),f.jsxs(yn,{children:[f.jsx("div",{style:{width:"50%"},children:"Kargo Takip No"}),f.jsx("div",{style:{width:"50%"},children:r.kargoTakipNo||"-"})]}),f.jsxs(yn,{children:[f.jsx("div",{style:{width:"50%"},children:"Kargo Firma"}),f.jsx("div",{style:{width:"50%"},children:r.kargoFirmaTanim||"-"})]}),f.jsx("div",{children:f.jsx(br,{mainColor:l,onClick:k,type:"button",children:"Yeni Sorgu Yap"})})]}):f.jsxs(ti,{children:[f.jsx(fa,{mainColor:l,children:"Sipariş Durumunu Sorgula"}),f.jsx(Or,{children:"Siparişinizin kargo takibini yapmak için telefon numaranızı giriniz."}),f.jsxs("form",{onSubmit:O,children:[f.jsx(Nl,{mainColor:l,type:"tel",onInput:B=>{B.currentTarget.value=B.currentTarget.value.replace(/[^0-9]/g,"")},...b("phone",{required:"Telefon numarası boş bırakılamaz",pattern:{value:/^5[0-9]{9}$/,message:"Telefon numarası 5 ile başlamalı ve 10 haneli olmalıdır"},validate:B=>/^(\d)\1+$/.test(B)||/^5(\d)\1{8}$/.test(B)||B==="5123456789"||B==="5987654321"?"Geçersiz telefon numarası":!0}),placeholder:"5XXXXXXXXX",maxLength:10}),T.phone&&f.jsx(Tt,{children:f.jsx("div",{style:{color:"red",fontSize:"14px",textAlign:"center"},children:T.phone.message})}),f.jsxs(So,{children:[f.jsx(wo,{mainColor:l,...b("kvkk",{required:"Lütfen bilgilerinizi paylaşmak için onay veriniz"}),type:"checkbox"}),f.jsxs("p",{style:{fontSize:"13px",lineHeight:"1.4",margin:0,color:"#666"},children:["Kampanya, duyuru ve bilgilendirmelerden E-Posta, WhatsApp ve SMS yoluyla haberdar olmak istediğimi belirtiyorum."," ",f.jsx("a",{style:{color:l||"#e7333c",textDecoration:"underline",fontWeight:"500"},href:"/UyelikSozlesme.aspx?sozlemeTipi=5",target:"_blank",rel:"noopener noreferrer",children:"Aydınlatma metni için tıklayın."})]})]}),T.kvkk&&f.jsx(Tt,{children:f.jsx("div",{style:{color:"red",fontSize:"14px",textAlign:"center",marginBottom:"10px"},children:T.kvkk.message})}),o&&f.jsx(Tt,{children:f.jsx("div",{style:{color:"red",fontSize:"14px",textAlign:"center"},children:"Telefon numarası ile eşleşen sipariş bulunamadı."})}),f.jsx("div",{children:f.jsx(br,{mainColor:l,children:"Sorgula"})})]})]})]})}),x.current):null},I5=il`
  0% {
    transform: rotate(0deg);
  }
  100% {
